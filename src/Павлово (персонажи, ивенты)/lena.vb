if $ARGS[0] = 'lena':
	...
	gs 'stat'
	if $metka = 'party_gost':
		gs 'zz_render', '', 'Лена','<center><img src="pavlovo/family/sister/sisterQW/ReksHome/Party_iralena_1_' + rand(1,5) + '.jpg"></center>','Лена и Ира вместе бурно веселятся.**-Света, че морозишься, давай отрываться.**И предлагают вам...'
	else
