...
if $npc['4,sex_day'] ! day:
	act 'Целоваться':
		*clr & cla
		...
		gs 'stat'
		gs 'zz_render', '', 'images/qwest/alter/kruglov/kiss.gif','Вы страстно целуетесь, он начинает мять вашу грудь, затем и гладить вашу промежность.\\\- Светик, я хочу тебя! Давай займёмся сексом... - ///шепчет он вам на ухо.'
...
if $npc['4,qwIgorMain'] = 9 and $inventory[8+'_count'] = 1 and $npc['4,day'] ! day: act 'Выпить вина с Игорем': gt 'igor_events','drink'
...
if hour = 20:
	*clr & cla
	gs 'npc_editor','get_npc_profile',4
	gs 'zz_render', '', '','Игорь смотрит на часы:**\\\ - Светик, Пойдёшь на дискотеку?///'
