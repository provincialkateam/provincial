$d_dima_end = {
	act 'Протирать глаза':
		*clr & cla
		minut += 5
		gs 'stat'
		gs 'zz_render', '','common/sex/facial/<<rand(0,4)>>.jpg', func('sny_strings', 'local_str1')
			...
			*clr & cla
			...
			act 'Ждать':
				*clr & cla
				...
				pose = 0
				gs 'stat'
				gs 'zz_render','','images/qwest/alter/ev2/fuck.jpg'
					...
					*clr & cla
					...
					act 'Сосать':
						*clr & cla
						...
						gs 'stat'
						gs 'zz_render', '','common/sex/facial/<<rand(0,4)>>.jpg', func('sny_strings', 'local_str7')
						if condomDima = 1:
							act 'Далее':
								*clr & cla
								gs 'zz_funcs', 'cum', 'face'
