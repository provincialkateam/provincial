...
$din_trener_vagin = {
	*clr & cla
	gs 'zz_render', '', 'images/pavlovo/dk/volley/voitrensex29.webm', func('Voltrenersex_strings', 'local_str4')
	act 'Далее':
		*clr & cla
		horny = 100
		minut += 15
		...
		gs 'stat'
		gs 'zz_render', '', 'images/pavlovo/dk/volley/voitrensex30.webm', func('Voltrenersex_strings', 'local_str5')
		act 'Далее':
			*clr & cla
			gs 'zz_render', '', 'images/pavlovo/dk/volley/voitrensex31.webm', func('Voltrenersex_strings', 'local_str6')
			act 'Далее':
				*clr & cla
				gs 'zz_render', '', 'images/pavlovo/dk/volley/voitrensex32.webm'
				gs 'zz_dynamic_sex', 'vaginal', 'dick'
				gs 'zz_render', '', '', func('Voltrenersex_strings', 'local_str7')
				act 'Только не в меня':
					*clr & cla
					gs 'zz_render','','images/pavlovo/dk/volley/voitrensex33.webm'
					$sexstart2orgazm5 = func('Voltrenersex_strings', 'local_str37')
					act 'Стереть сперму':
						*clr & cla
						gs 'zz_funcs', 'cum', 'lip'
						gs 'zz_render', '', 'images/pavlovo/dk/volley/voitrensex34.webm', func('Voltrenersex_strings', 'local_str8')
						act 'Уйти':gt'gdksport'
					end
				end
			end
		...
		*clr & cla
		...
		act 'Далее':
			*clr & cla
			...
			act'Прийти в себя':
				*clr & cla
				gs 'zz_render', '', 'images/pavlovo/dk/volley/voitrensex28.webm', func('Voltrenersex_strings', 'local_str12')
				act 'Уйти':gt'gdksport'
			end
		end
	end
