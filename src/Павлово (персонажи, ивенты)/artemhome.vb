...
frost = 0
					...
					*clr & cla
					...
					act 'Идти с парнями':
						*clr & cla
						minut += 15
						gs 'stat'
						gs 'zz_render','','images/qwest/alter/artom/meet/hack_3.jpg'
						gs 'zz_render', '', '', func('artemhome_strings', '5')
						act 'Раздеться':
							*clr & cla
							gs 'stat'
							gs 'zz_render','','images/qwest/alter/artom/meet/hack_4.jpg'
							...
							act 'Встать раком':
								*clr & cla
								...
								anus += 1
								gs 'stat'
								gs 'zz_render','','images/qwest/alter/artom/meet/hack_5.jpg'
								gs 'zz_render', '', '', func('artemhome_strings', '7')
								act 'Покорно ждать':
									*clr & cla
									gs 'zz_render','','images/qwest/alter/artom/meet/hack_6.jpg'
									...
									act 'Сосать':
										*clr & cla
										...
										artemblok = 1
										gs 'stat'
										gs 'zz_render','','images/qwest/alter/artom/meet/hack_7.jpg'
										gs 'zz_render', '', '', func('artemhome_strings', '9')
										act 'Посмотреть на Артёма':
											*clr & cla
											gs 'zz_render','','images/qwest/alter/artom/2.jpg'
											gs 'zz_render', '', '', func('artemhome_strings', '10')
											act 'Возмутится':
												*clr & cla
												gs 'zz_render','','images/qwest/alter/artom/meet/hack_8.jpg'
	...
	if artemtimes >= 45 and artomProgul ! day and (func('zz_reputation','get') < 2 or artemblag = 1):
		artomProgul = day
		cla
		gs 'stat'
		if rand(0,1) = 0:
