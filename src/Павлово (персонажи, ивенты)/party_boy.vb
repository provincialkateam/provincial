if $ARGS[0] = 'party_boy':
	*clr & cla
	...
	elseif dj_beer = 1 and dj_thank < 1:
		...
		gs 'zz_render','','','Вы взяли на кухне две бутылки пива и можете <a href="exec:dynamic $party_dj_beer">передать</a> их парням.'
	elseif dj_thank = 1 and dj_bad < 1:
		gs 'zz_render', 'Диджей', $zz_str, func('party_boy_strings', 'local_str3')
		gs 'zz_render','','','Вам разрешили <a href="exec:dynamic $party_dj_thank">покрутить</a> вертушку.'
	...
	elseif dj_boobs = 1:
		...
		gs 'zz_render','','','Вам снова разрешили <a href="exec:dynamic $party_dj_cock">покрутить</a> вертушку.'
	end
	killvar '$zz_str'
