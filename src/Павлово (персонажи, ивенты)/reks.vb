			...
			*clr & cla
			...
			act 'Далее':
				*clr & cla
				minut += 30
				gs 'stat'
				gs 'zz_render','','images/qwest/alter/Reks/progulpark.jpg', func('reks_strings', 'local_str17')
				act 'Идти в парк':
					*clr & cla
					minut += 10
					gs 'stat'
...
if $ARGS[0] = 'sms':
	*clr & cla
	...
	rexSmsDay = daystart
	gs 'stat'
	gs 'zz_render','','images/qwest/alter/Reks/SmartSist.jpg'
	if horny < 50:
...
$Party_rex_sex_cow ={
	*clr & cla
	...
	if $npc['27,sex'] < 2:
		gs 'zz_render','','','Немного снизив темп, Рекс попросил сменить позицию... '
		act 'Лечь на спину': dynamic $Party_rex_sex_missionary
		act 'Встать раком': dynamic $Party_rex_sex_dog
	else
		gs 'zz_render','','','Рекс с дикой страстью дерет вашу дырочку, он почти на грани и готов...'
