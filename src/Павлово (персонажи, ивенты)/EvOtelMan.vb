if $args[0] = '' or $args[0] = 'main':
	...
	$npc['0,hotel_sex'] += 1
	gs 'stat'
	gs 'zz_render','','pavlovo/dk/disco/drinking/2/taxi', 'Мужчина подошел к стоящему рядом с клубом таксисту и перемолвившись с ним парой фраз обернулся к вам:**\\\- Светик поехали.///**Вы вместе с мужчиной сели в такси и быстро доехали до отеля. Мужчина повел вас к себе в номер.'
	act 'Идти в номер':
		*clr & cla
		if DPtipe = 1:
...
if $args[0] = 'hotel_bj':
	*clr & cla
	...
	dynamic $venerasiak
	gs 'stat'
	gs 'zz_render','','common/sex/bj/4.gif','Вы сели на корточки перед мужчиной и взяли его член рукой. Немного подвигав кожицу на члене вы облизнули головку. Ваш ловкий язычок начал ласкать горячий и твердый член мужчины. <<$bname>> сказал:**\\\- Светик, я так скоро кончу.///'
	act 'Сосать':
		*clr & cla
		gs 'zz_funcs','cum','lip'
		minut += rand(5,10)
