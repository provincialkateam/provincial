...
$din_trener_masaj = {
	...
	act 'Согласиться':
		*clr & cla
		gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj1.webm', func('Voltrener_strings', 'local_str5')
		act 'Раздеться':
			*clr & cla
			gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj2.webm', func('Voltrener_strings', 'local_str6')
			act 'Лечь':
				*clr & cla
				gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj3.webm', func('Voltrener_strings', 'local_str7')
				act 'Расслабиться':
					*clr & cla
					gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj4.webm', func('Voltrener_strings', 'local_str8')
					act 'Далее':
						*clr & cla
						gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj5.webm', func('Voltrener_strings', 'local_str9')
						act 'Далее':
							*clr & cla
							son += 5
							minut += 30
							manna += 20
							gs 'stat'
							gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj6.webm', func('Voltrener_strings', 'local_str10')
							act 'Всё': gt'gdksport'
							if horny >= 100 and mesec <= 0:
								act 'Продолжим':
									*clr & cla
									gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj7.webm', func('Voltrener_strings', 'local_str11')
									act 'Далее':
										*clr & cla
										orgasm += 1
										kuni += 1
										...
										gs 'stat'
										gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj8.webm', func('Voltrener_strings', 'local_str12')
										act 'Прийти в себя':
											*clr & cla
											gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj9.webm', func('Voltrener_strings', 'local_str13')
											act 'Облизать':
												*clr & cla
												gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj10.webm', func('Voltrener_strings', 'local_str14')
												act 'Открыть рот':
													*clr & cla
													gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj11.webm', func('Voltrener_strings', 'local_str15')
													act 'Проглотить':
														*clr & cla
														swallow += 1
														gs 'zz_funcs', 'cum', 'lip'
														...
														$npc['28,sex'] += 1
														gs 'stat'
														gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj12.webm', func('Voltrener_strings', 'local_str16')
														act 'Далее':
															*clr & cla
															gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerMasaj13.webm', func('Voltrener_strings', 'local_str17')
...
act 'Поговорить с тренером':
	*clr & cla
	gs 'zz_render','','images/pavlovo/dk/volley/Tren/VolleyTrener6.jpg'
	if volleysostav = -1:
		if $npc['28,sex'] = 0:
