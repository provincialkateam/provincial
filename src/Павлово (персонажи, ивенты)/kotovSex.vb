...
if $args[0] = 'kotov_bj':
	act 'Взять в рот':
		*clr & cla
		...
		kotovBJtimes += 1
		gs 'stat'
		gs 'zz_render','','common/sex/bj/<<rand(0,4)>>.gif',func('kotovsex_str',18)
		if kotovBJtimes > 5:
			act 'Продолжить сосать':
				*clr & cla
				...
				gs 'zz_funcs', 'cum', 'lip'
				gs 'stat'
				gs 'zz_render','','common/sex/bj_cum/<<rand(0,4)>>.gif',func('kotovsex_str',19)
				...
				if kotovBJtimes > 10:
					act 'Сосать удерживая сперму во рту':
						*clr & cla
						minut += 5
						gs 'stat'
						gs 'zz_render','','common/sex/bj_cum/<<rand(0,4)>>.gif',func('kotovsex_str',21)
						act 'Выплюнуть':
							*clr & cla
							minut += 5
							gs 'stat'
						...
						if kotovBJtimes > 12:
							act 'Проглотить':
								*clr & cla
								...
								swallow += 1
								gs 'stat'
								gs 'zz_render','','common/sex/bj_cum/<<rand(0,4)>>.gif',func('kotovsex_str',23)
								act 'Уйти': minut += rand(10,15) & gt 'gorodok'
							end
						end
						if kotovBJtimes > 15:
							act 'Играть со спермой':
								*clr & cla
								...
								swallow += 1
								gs 'stat'
								gs 'zz_render','','common/sex/bj_cum/<<rand(0,4)>>.gif',func('kotovsex_str',24)
								act 'Уйти': minut += rand(10,15) & gt 'gorodok'
							end
						end
					end
		...
		act 'Вынуть изо рта':
			*clr & cla
			minut += 5
			gs 'stat'
			gs 'zz_render','','common/sex/hj/<<rand(0,4)>>.gif',func('kotovsex_str',25)
			if kotovBJtimes > 15:
				act 'Направить на лицо':
					*clr & cla
					...
					gs 'stat'
					gs 'zz_render','','common/sex/facial/<<rand(0,4)>>.jpg',func('kotovsex_str',26)
					act 'Уйти': minut += rand(10,15) & gt 'gorodok'
				end
			end
			act 'Кончить в ладони':
				*clr & cla
				minut += 5
				gs 'stat'
				gs 'zz_render','','common/sex/hj/<<rand(0,4)>>.gif',func('kotovsex_str',27)
				act 'Уйти': minut += rand(10,15) & gt 'gorodok'
			end
		end
	end
