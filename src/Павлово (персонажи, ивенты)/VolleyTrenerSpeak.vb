		...
		if horny > 80:
			...
			act 'Задрать подол':
				*clr & cla
				...
				horny += 10
				if cloth[1] = 1: gs 'zz_render', '', 'images/pavlovo/dk/volley/voitrensexdisco2.webm', func('VolleyTrenerSpeak_strings', 'local_str30')
				if cloth[1] = 0: gs 'zz_render', '', 'images/pavlovo/dk/volley/voitrensexdisco3.webm', func('VolleyTrenerSpeak_strings', 'local_str31')
				act 'Выставить попку':
					*clr & cla
					horny += 10
					minut += 20
							...
							*clr & cla
							...
							act'Пойти с тренером':
								*clr & cla
								...
								minut += 20
								gs 'stat'
								gs 'zz_render', '', 'pavlovo/street/str_night.jpg', func('VolleyTrenerSpeak_strings', 'local_str5')
			...
			gs 'zz_render', '', 'images/pavlovo/dk/volley/voitrensexdisco7.webm', func('VolleyTrenerSpeak_strings', 'local_str6')
			act 'Пойти с тренером':
				*clr & cla
				Discoclose=1 &!закрытие диско на этот день не забыть про stat
				minut += 20
				gs 'stat'
				gs 'zz_render', '', 'pavlovo/street/str_night.jpg', func('VolleyTrenerSpeak_strings', 'local_str7')
				dynamic $din_trener_Speak
			end
		end
	end
...
$din_trener_Speak={
	act 'Попробовать поговорить':
		...
		if $npc['28,relation'] => 40 and trener_Speak=0:
			...
			act 'Прервать':
				*clr & cla
				horny += 10
				gs 'stat'
				if Discoclose=1: gs 'zz_render', '', 'pavlovo/dk/volley/VoltrenerSpeak1.webm', func('VolleyTrenerSpeak_strings', 'local_str36')
				if trenerskaia=1 and Discoclose=0:gs 'zz_render','','pavlovo/dk/volley/VoltrenerSpeak2.webm', func('VolleyTrenerSpeak_strings', 'local_str35')
				act 'Уйти':
		...
		elseif $npc['28,relation']>30 and trener_Speak=3:
			...
			act 'Проверить':
				*clr & cla
				horny+= 10
				gs 'stat'
				if Discoclose=1: gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerSpeak3.webm', func('VolleyTrenerSpeak_strings', 'local_str37')
		...
		elseif $npc['28,relation']>40 and trener_Speak=4 and VoltrenerVoyeur=3:
			...
			if horny>80:
				gs 'npc_editor','change_rep','+', 28
				gs 'zz_render','','','Вы решаете проверить так уж он переживает как говорит.'
			end
			act'Проверить':
				*clr & cla
				horny += 10
			...
			*clr & cla
			...
			act 'Стерпеть обиду':
				*clr & cla
				...
				if Discoclose=1 and cloth[1] = 1: gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerSpeak25.jpg', func('VolleyTrenerSpeak_strings', 'local_str45')
				if Discoclose=1 and cloth[1] = 0: gs 'zz_render', '', 'images/pavlovo/dk/volley/VoltrenerSpeak24.gif', func('VolleyTrenerSpeak_strings', 'local_str46')
	...
	if Joke >= 3:
		...
		act'Пойти с тренером':
			*clr & cla
			...
			minut += 20
			gs 'stat'
			gs 'zz_render', '', 'pavlovo/str_night.jpg', func('VolleyTrenerSpeak_strings', 'local_str29')
			dynamic $din_trener_Speak
		end
	end
end
