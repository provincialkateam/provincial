...
if vok_toilet_event > 0:
	...
	if voyeurism > 40:
		act 'Подглядеть':
			...
			gs 'zz_render','','images/wannabe/tualete/men/<<rand(0,4)>>.jpg','Вы оторвали свой взляд от тряпки, который вы мыли пол и стали подглядывать за тем как он отливает. '+iif(voyeurism > 30,'Зрелище немного вас возбудило.','')
...
if $args[0] = 'vok_toilet_event_strings':
	...
	if $args[1] = 'toilet_event3': $result = ' в него зашёл гоповатого вида парень. Он подмигнул вам и сказал: \\\- Чё каво, кисуля?/// Не дождавшись ответа он подошёл к писсуару и начала писать.'
