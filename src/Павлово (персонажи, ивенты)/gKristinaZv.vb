		...
		if vagina = 0:
			*clr & cla
			...
			elseif anus >= 15 and anus < 25:
				...
				gs 'zz_funcs','set_gape','anus', iif(lubri>0,10,0),30,1
				horny = RAND(50,75)
				gs 'stat'
			...
			if vagina < 10: horny = RAND(5,15)
			if vagina >= 10 and vagina < 15: horny = RAND(25,35)
...
elseif randhumiliation = 13 and vagina > 0:
	...
	act 'Засовывать':
		*clr & cla
		if zverhumiliation < 14:zverhumiliation += 1
		dom -= 1
		if vagina < 10: horny = RAND(10,20)
		if vagina >= 10 and vagina < 15: horny = RAND(30,50)
		if vagina >= 15: horny = RAND(50,75)
		gs 'zz_funcs','set_gape','vagina',horny, 15, 1
		minut += RAND(15,20)
		gs 'stat'
