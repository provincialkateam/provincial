...
if $ARGS[0] = 'DrunkGirl_exit':
	...
	gs 'zz_render','','','\\Это пиздец!// – думаете вы: \\на ТАКУЮ работу я не подписывалась!!!//'
	act 'Уволиться':
		cla & *clr
		DrunkGirl_end = 1
		vokzalVork = 0
		gs 'zz_render','','images/wannabe/vokzal_nach.jpg','Вы врыветесь в кабинет начальника вокзала: \\– Я НЕ НАМЕРЕНА РАБОТАТЬ В ТАКИХ УСЛОВИЯХ!!// – кричите вы. \\– Я ТОЛЬКО ВСЁ УБРАЛА, А ОНА НА ПОЛ ССЫТ!!!//. Начальник с удивлением смотрит на вас. Вы понимаете, что со стороны это выглядит нелепо и буквально вылетаете из кабинета.'
		act 'Далее': gt'vokzalGin'
	end
	act 'Не увольняться':
		cla & *clr
		gs 'zz_render','','','\\Ладно. Бывают в жизни вещи и похуже.// – философски думаете вы.'
		act 'Далее': gt'vokzalGin'
	end
end
if $ARGS[0] = 'PissGirl':
gs 'zz_render','','images/wannabe/tualete/women/WomanToiletPiss_'+RAND(1,5)+'.jpg','Вы начинаете мыть пол перед занятой кабинкой и как бы невзначай заглядываете внутрь.'
act 'Домыть пол и уйти': gt'vokzalGin'
end
if $args[0] = 'strings':
	...
	if $args[1] = 'DrunkGirl_1': $result = '\\– Может быть, вам чем-нибудь помочь?// – говорите вы.**Девушка мотает головой и говорит заплетающимся языком: \\\- Аааэээааааааа. Всёё нооооормаально. Счас.../// - с этими словами она начинает задирать своё платье по самые сиськи. Трусов на девушке не оказалось – видимо уже где-то потеряла.**\\"Ага, нормально. Она сейчас мне весь пол тут заблюёт!"// – думаете вы.'
	...
	if $args[1] = 'DrunkGirl_3': $result = 'Вы кричите на девушку: \\– Cука! Мать твою, ты что творишь! Говно собачье, а!? Ты, засранка вонючая! Посмотри - ты мне весь пол обоссала! Кто это по-твоему будет убирать, а? Иди сюда, бери швабру и убирай всё, что наделала!//**Но девушка никак особенно не реагирует на вашу гневную тираду. \\\- Не мешай. Ээээ.../// - слышите вы. '
	if $args[1] = 'DrunkGirl_4': $result = 'Вы хватаете эту зассыху за волосы и сдёргиваете её с унитаза. \\– Ах ты, мразь! Решила, что я с тобой шутки шутить буду?! Со мной этот номер не пройдёт!// – кричите вы: \\– Не захотела убирать шваброй?! Значит будешь вылизывать языком свою ссанину, тварь!//'
	if $args[1] = 'DrunkGirl_5': $result = 'С этими словами вы толкаете девушку и она падает на пол рядом с унитазом, прямо в лужу своей мочи. \\– А ну достала свой поганый язык и лижи пол, мразь!// – кричите вы. Девушка лежит без движения на полу, такое впечатление что без сознания, но удар ногой в живот приводит её в чувства и она начинает скулить, а после второго высовывает язык и начинает лизать пол.'
	if $args[1] = 'DrunkGirl_6': $result = '\\– И здесь ты тоже всё обоссала.// – говорите вы, поднимаете девушку за волосы и тыкаете губами в бортик унитаза: \\– Лижи давай, мразина.// Девушка послушно выполняет ваш приказ.'
