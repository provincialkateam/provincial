...
if $ARGS[0] = 'hall':
	*clr & cla
	...
	minut += 5
	gs 'stat'
	gs 'zz_render','','images/qwest/nord/clinic/misha/kor.jpg'
	if nanny_vika = 1:
...
if $ARGS[0] = 'room':
	*clr & cla
	...
	minut += 5
	gs 'stat'
	gs 'zz_render','','images/qwest/nord/clinic/misha/kom.jpg'
...
if $ARGS[0] = 'kitchen':
	*clr & cla
	...
	minut += 5
	gs 'stat'
	gs 'zz_render','','images/qwest/nord/clinic/misha/kuh.jpg'
...
if $args[0] = 'vika':
	...
	act'Поболтать':
		*clr & cla
		...
		! strings array
		$zz_str[0] = 'Вы болтаете с Викой, шутите, смеётесь. Она очень весёлая девушка.'
		$zz_str[1] = 'Вика учится в медицинском на последнем курсе и охотно делится забавными историями оттуда.'
		$zz_str[2] = 'Вы спросили у Вики про ее парня. Она заулыбалась: "Ну, у меня есть парень. Представляешь кажется он ревнует меня к Михаилу, говорит что я уже изменилась."'
		$zz_str[3] = 'Вы болтаете с Викой и она рассказывает вам, что ходила раньше на танцы, но из за нехватки денег ей пришлось бросить.'
		$zz_str[4] = 'Вы болтаете с Викой, обсуждая последние тенденции в моде.'
		$zz_str[5] = 'Вы с Викой, болтая, обсуждаете и Михаила.'
		$zz_str[6] = 'Вы болтаете с Викой: она рассказывает про Михаила, что он хороший и щедрый человек.'
		! print random string
...
if $args[0] = 'misha':
	...
	act'Поболтать':
		*clr
		...
		$zz_str[0] = 'Болтая с Михаилом, вы узнаёте что он тоже родился в Павлово как и вы. Его семья переехала в сюда, когда ему было семь. В семье было четверо детей, он — старший. Он говорит, что часто воспоминает о жизни, которую он вел до того как перенес полиомиелит.'
		$zz_str[1] = '\\\- В раннем возрасте у меня умерла сестра, Настя, умерла от пневмонии. Тогда я уже несколько лет болел полиомиетитом, и с тех пор я не мог избавиться от чувства вины./// - Ему казалось, что родители, особенно мать, уделяли ему слишком много внимания в ущерб другим. Ничто не указывало на то, что его опасения обоснованы, но избавиться от чувства вины Михаил так и не смог.'
		$zz_str[2] = '\\\- В детстве я очень любил играть с соседскими детьми/// -  расказывает он. -\\\ Но болезнь обрушилась на меня когда мне было шесть лет, и я сразу же стал главной заботой своей семьи, особенно матери. Она полностью посвятила себя мне. На протяжении всех ранних лет моей жизни она ухаживала за мной с неизменной лаской и терпением.///'
		...
		$zz_str[5] = 'Вы разговариваете с Михаилом, он рассказал вам что он не то чтобы парализован, просто у него не работают мышцы.'
		$zz_str[6] = '\\\- Вы верующая?/// - спросил он вас.**\\ - Да не особо как то// - ответили вы.**\\\ - А я все еще верю. Нужно же мне хоть кого-то обвинять во всём, что со мной происходит?/// - с улыбкой сказал он.'
		! print random string
	...
	if nanny_cleaning = 1 and nanny_food = 1 and nanny_story = 1:
		act 'Я всё сделала':
			*clr & cla
			...
			act 'Слушать':
				*clr & cla
				gs 'zz_render', '', 'images/qwest/nord/clinic/vika/massage.webm', func('misha_inv_strings', 'local_str75')
				act 'Дальше':
					*clr & cla
					gs 'zz_render', '', 'images/qwest/nord/clinic/vika/massage2.webm', func('misha_inv_strings', 'local_str76')
					act 'Слушать':
						*clr & cla
						gs 'zz_render', '', 'images/qwest/nord/clinic/vika/6.webm', func('misha_inv_strings', 'local_str77')
						act 'Дальше':
							*clr & cla
							gs 'zz_render', '', 'images/qwest/nord/clinic/vika/shave.webm', func('misha_inv_strings', 'local_str78')
							act 'Дальше':
								*clr & cla
								gs 'zz_render', '', 'images/qwest/nord/clinic/vika/walk0.webm', func('misha_inv_strings', 'local_str79')
								act 'Дальше':
									*clr & cla
										...
										*clr & cla
										...
										act 'Дальше':
											*clr & cla
											...
											act 'Дальше':
												*clr & cla
												gs 'zz_render', '', 'images/qwest/nord/clinic/vika/6.webm', func('misha_inv_strings', 'local_str83')
												act 'Дальше':
													*clr & cla
													gs 'zz_render', '', 'images/qwest/nord/clinic/vika/kiss.webm', func('misha_inv_strings', 'local_str84')
													act 'И дальше что?':
														*clr & cla
														gs 'zz_render', '', 'images/qwest/nord/clinic/vika/picnic.webm', func('misha_inv_strings', 'local_str85')
														act 'Слушать дальше':
															*clr & cla
															gs 'zz_render', '', 'images/qwest/nord/clinic/vika/walk4.webm', func('misha_inv_strings', 'local_str86')
