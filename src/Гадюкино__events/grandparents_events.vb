	...
	*clr & cla
	...
	act 'Отпустить':
		...
		*clr
		...
		gs 'zz_render','','','- Ладно Мира, добрая я сегодня. Можешь считать себя прощенной, - сказали вы, снимая с Миры ошейник.'
		gs 'zz_render','','','Девушка еще пару мгновений смотрит на вас, потом быстро одевается и убегает домой.'
		act 'Далее':gt'Gadsarai'
	end
...
if $ARGS[0] = 'mira_courtyard':
	*clr & cla
	...
	gs 'stat'
	dynamic $miraclothes
	gs 'zz_render', '', '','Вы вышли во двор и заметили идущую на встречу Мирославу.**\\\ - О, Света привет, а я к тебе в гости. Заскучала совсем одна дома, -/// сказала она улыбаясь.'
...
if $ARGS[0] = 'mira_house':
	*clr & cla
	...
	gs 'stat'
	dynamic $miraclothes
	gs 'zz_render', '', '','Вы были в избе, когда заметили входящую Мирославу.**\\\- Тук-тук, Света привет, я к тебе в гости. А то заскучала совсем одна дома, -/// сказала она улыбаясь.'
...
if $ARGS[0] = 'courtyard_nude':
	*clr & cla
	minut += 5
	gs 'stat'
	gs 'zz_render', '', 'qwest/gadukino/new/'+iif(func('zz_weather','is_day')=1,'gaddvor_nude' ,'gadukino_back_night')+'.jpg',iif(grandpa_ingaddvor = 0,'Вы зашли во двор и никого не встретив отправились в избу.','Вы вышли во двор и сразу наткнулись на дедушку...')
...
if $ARGS[0] = 'garden_nude':
	*clr & cla
	minut += 5
	gs 'stat'
	gs 'zz_render', $_str, 'qwest/gadukino/new/'+iif(func('zz_weather','is_day')=1,'gadgarden_nude' ,'gadukino_back_night')+'.jpg'
...
if $ARGS[0] = 'market':
	*clr & cla
	...
	gs 'stat'
	gs 'zz_render','','qwest/gadukino/grandma.jpg','Вы зашли в магазин и увидели свою бабулю. Заметив вас, она улыбнулась.**\\\- Светуля, хорошо, что ты зашла. Иди, я тебе гостинца куплю, -/// сказала она, и купив упаковку печенья, протянула вам.**\\- Спасибо, бабуль, -// ответили вы, и поцеловав бабушку в щёку, отошли.'
...
if $ARGS[0] = 'talk_swamp':
	*clr & cla
	...
	if back_swamp = 0:
		back_swamp = 1
		grandmaQW += 1
		gs 'zz_render', '', '','В избе вас уже ждала бабушка, с опухшими от слез глазами.**\\\- Светуля ты где пропадала? -/// кинулась она к вам.\\\ - Мы с дедом с ног сбились, разыскивая тебя. Уже не знали, что и подумать...///**\\- Ба, ээээ... ну так вышло, -// начали мямлить вы, пытаясь как-то сгладить свой безответственный поступок.\\ - Я в лесу была... потом на болото попала... ну и задержалась немного у охотников в избушке.//**\\\- Совести у тебя нету Света, -/// сказала бабушка, все еще тиская и ощупывая вас, как будто проверяла, все ли части тела на месте.\\\ - Вот если бы с тобой что-нибудь случилось, чтобы мы с дедом делали? Чтобы матери твоей сказали? Ты о нас с ней хоть подумала?///**\\- Бабуль, ну не плачь, -// обняли в ответ вы бабушку, чувствуя, что глаза самопроизвольно начинают наполняться слезами.\\ - Я больше так не буду... честно-честно.//**Проплакав и пообнимавшись еще какое-то время вы наконец с бабушкой разошлись.'
	else
		grandmaQW -= 20
		grandpaQW -= 20
		gs 'zz_render', '', '','В избе вас уже ждала бабушка, глядя на вас с укоризной.**\\\- Света ты же обещала... -/// только и произнесла она.**\\- Бабуль... -// начали вы, но она уже отвернулась и занялась своими делами.'
	end
	act 'Далее':gt'Gadhouse'
end