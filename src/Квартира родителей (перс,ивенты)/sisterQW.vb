...
if $args[0] = 'sisboytrio_prepeare':
	*clr & cla
	if sisboytrio = 1:
		gs 'zz_render', '', 'pavlovo/family/sister/sisterQW/sisboyQW_41.jpg', func('sisterQW_strings', 'local_str20')
	elseif sisboytrio = 2:
	...
	if $sister['location'] = 'gdk' or $sister['location'] = 'glake' or $sister['location'] = 'cafe_parco':
		if $npc['38,relation'] < 40:
			...
			act 'Пить пиво':
				cla & *clr
				if AniaFrends = 1:
					if rand(0,1) = 0 and $npc['38,qwSisterTrio'] > 0:
						gt 'dinsister','beach_events'
					else
						gt 'annafrends'
					end
				else
																			...
																			if horny >= 90 and $npc['38,Kolkawin'] = 1 :
																				act'Кончить':
																					*clr & cla
																					...
																					horny = 0
																					gs 'stat'
																					gs 'zz_render', '', 'pavlovo/family/incest/event1/25.jpg','Бурно кончая вы завизжали так, что вас, наверно, услышали ближайшие несколько этажей, от такого ору Аня проснулась, с просони не совсем понимая, что случилось.**\\\- Что тут происходит, что за крики?/// - Аня, протирая глаза, уставилась на соседнюю кровать.**\\\- Светик, нахера ты ебаря к нам в комнату притащила родители узнают даже не знаю, что с тобой сделают!/// - сказала Аня и начала подниматься с кровати, чтобы разобраться с вашим блядством.'
																					act'Далее':
																						*clr & cla
																						minut += 1
																						gs 'stat'
															...
															*clr & cla
															...
															act'Далее':
																*clr & cla
																...
																act'Идти в ванную': gt 'zz_bathroom','init','korrPar'
															end
														end
													end
												end
																				...
																				*clr & cla
																				...
																				act'Далее':
																					*clr & cla
																					...
																					horny = 0
																					gs 'stat'
																					gs 'zz_render', '', 'pavlovo/family/incest/event3/21.jpg','Через несколько секунд вы почувствовали горячую спермы у себя во рту.**\\\- Ай да Светик! Хороша почти как моя бывшая!///**\\- Ну не наглец ли?// - возмутились вы полушутя:\\- Нет бы сказал: “Лучше моей бывшей!”//**\\\- Светка, до моей бывшей тебе ещё попрактиковаться надо малость. Хочешь - могу дать пару уроков?/// - ухмыльнулся Миша.'
																					act'Далее':
																						*clr & cla
																						minut += 1
																						gs 'zz_funcs', 'cum', 'face'
	...
	*clr & cla
	...
	act'Далее':
		*clr & cla
		minut += 1
		gs 'stat'
		gs 'zz_render', '', 'pavlovo/family/incest/event3sub/02.jpg','Немного погоняв, Мишка понял, что ваши навыки игрока стремятся к нулю.**\\\- Светуля, может поиграем в игры которые тебе даются лучше?///- с этими словами Мишка стал вас целовать.'
		act'Далее':
			*clr & cla
			minut += 1
			gs 'stat'
						...
						*clr & cla
						...
						act'Далее':
							*clr & cla
							minut += 1
							gs 'stat'
							gs 'zz_render', '', 'pavlovo/family/incest/event3sub/'+rand(7,8)+'.jpg','Вы с энтузиазмом начали обрабатывать Колькин член, когда почувствовали что Мишка трахает вашу киску своим пальцем.**\\\- Мокренькая, как и всегда! Светуля, ты похоже нимфоманка. Всегда рада гостям,/// - хмыкнул Мишка,\\\- Тебе с такой жаждой траха внутри самое место в порнобизнесе.///'
							act'Далее':
								*clr & cla
								minut += 1
								gs 'stat'
								gs 'zz_render', '', 'pavlovo/family/incest/event3sub/'+rand(9,11)+'.jpg','Как только Миша наигрался с вашей дырочкой, вы тут же уселись на корточки и начали работать сразу с обоими инструментами парней, то полизывая, то посасывая их и поочередно и оба сразу.**\\\- Я бы тоже в порно пошел,/// - пробормотал Колька,\\\особенно если там все так сосут как Светик.///'
								act'Далее':
									*clr & cla
									minut += 1
									gs 'stat'
															...
															*clr & cla
															...
															act'Далее':
																*clr & cla
																...
																gs 'stat'
																gs 'zz_render', '', 'pavlovo/family/incest/event5/16.jpg','Закончив свое дело, брат приподнял вас и нежно поцеловал, а вы, ощущая как с вас стекают обе жидкости и капают на пол, почувствовали себя на седьмом небе от счастья.**\\\- Светуля, ну что теперь в душ?///**\\- Ага!// - кивнув головой сказали вы.\\Только я тут мигом уберу...ммм, всякое,// - вы хихикнули и подмигнули:\\- Готовься к встрече с обеими сестрами, держи себя в форме, футболист!//'
	...
	*clr & cla
	...
	act'Далее':
		*clr & cla
		minut += 1
		gs 'stat'
		gs 'zz_render', '', 'pavlovo/family/incest/event6/03.jpg','Вы начали раздеваться, Аня решила вам помочь**\\\-Светуля, у тебя соски торчат ты что, уже возбудилась?/// - ухмыльнулась Анька**\\- Ага, я уже вся в предвкушении сегодняшнего вечера.//'
		act'Далее':
			*clr & cla
			minut += 1
			gs 'stat'
...
if $args[0] = 'incest_event7':
	*clr & cla
	minut += 1
	gs 'stat'
	gs 'zz_render', '', 'pavlovo/family/incest/event7/01.jpg','\\- Мальчики, я сегодня слегка припозднилась: наряжалась специально для вас,// - сообщили вы, входя в комнату.**\\- Нравится?// - приоткрывая свою грудь, спросили вы.**\\\- Светуля, нам не то что на тебе надето, а то что под одеждой скрыто интересно,/// - слегка хамовато ответил Мишка.'
	act'Далее':
		*clr & cla
		minut += 1
		gs 'stat'
...
if $args[0] = 'incest_event8':
	*clr & cla
	...
	lubri -= 1
	gs 'stat'
	gs 'zz_render', '', 'pavlovo/family/incest/event8/01.jpg','Как и договаривались ранее, вы пришли в зал одевшись как явная распутница. Там вас уже с нетерпением ожидали:**\\\- О, Светик, как тебе идет наряд шлюхи-то! А теперь: покажи-ка нам свои прелести!/// - нагло усмехаясь, сказал отчим.'
	act'Далее':
		*clr & cla
		minut += 5
		gs 'stat'
		gs 'zz_render', '', 'pavlovo/family/incest/event8/02.jpg','Вы с нарочитым вызовом медленно разделись, встали коленями на столик стоящий посередине комнаты и выставили на обозрение всю промежность.**\\\- Отлично, ну что, начнем без прелюдий?/// - спросил отчим.**\\- Только не сразу два в попку!// - хоть вы и смазали ее лубрикантом, вас терзали некоторые сомнения: влезут ли сразу оба?**\\\- Пап, предлагаю сперва по одному на дырочку./// - сказал Колька.'
		act'Далее':
			*clr & cla
			minut += 5
			gs 'stat'
							...
							*clr & cla
							...
							act'Далее':
								*clr & cla
								...
								act 'Уйти': gt 'zz_bathroom','init','korrPar'
							end
						end
					end
				end
			...
			*clr & cla
			...
			act'Далее':
				*clr & cla
				minut += 3
				gs 'stat'
				gs 'zz_render', '', 'pavlovo/family/incest/event8sub/04.webm','Папочка с Коляном раздевают вас под кокетливые хихиканья.**\\\- Ого, Светик, ну у тебя и румянец! Жаром так и пылаешь!///**\\- Мммм, хочу два члена, хочу в каждую дырку, и чтоб быть отодранной круче, чем потаскухи в порно!//'
				act'Далее':
					*clr & cla
					minut += 3
					gs 'stat'
																		...
																		*clr & cla
																		...
																		act'Далее':
																			*clr & cla
																			...
																			gs 'zz_funcs', 'cum', 'pussy'
																			gs 'zz_funcs', 'cum', 'face'
																			gs 'zz_funcs','set_gape','anus', iif(lubri>0,10,0),29,1
																			gs 'stat'
					...
					*clr & cla
					...
					act'Далее':
						*clr & cla
						minut += 1
						gs 'stat'
						gs 'zz_render', '', 'pavlovo/family/incest/event10/06.jpg','Вы сменили партнеров, зато позы на этот раз были почти одинаковые. Вздохи и повизгивания шли от вас обеих нескончаемым потоком.**\\- А теперь пусть Аня получит что хотела ведь это для нее все и организовывалось,//- сквозь стоны предложили вы.**\\\- Светик! Ты из меня такую же нимфоманку как сама сделать хочешь!///- провопила сестра.**\\- А тебе, можно подумать, не нравится! Мальчики ну-ка покажите этой недотроге! Растрахайте ее на пару, наконец!//'
						act'Далее':
							*clr & cla
							minut += 1
							horny += 20
																...
																*clr & cla
																...
																act'Далее':
																	*clr & cla
																	...
																	horny = 90
																	gs 'stat'
																	gs 'zz_render', '', 'pavlovo/family/incest/event11/17.jpg','Мишка усаживает вас на раскаленный орган:**\\\- Давай, Светик, сейчас, уже скоро...прыгай...ой..на-а..///**\\- Мамочка-а, я же еще кончу-у…,//- в экстазе вопите вы.**Зафаканная балдеющая Аня с чмоканьем обсасывает елдак брата.'
																	act'Далее':
																		*clr & cla
																		minut += 30
																		orgasm += 1
																	...
																	act'Далее':
																		*clr & cla
																		...
																		act'Далее':
																			*clr & cla
																			minut += 30
																			gs 'zz_funcs','set_gape','anus', iif(lubri>0,10,0),29,2
																			anus += 1
																			$npc['38,anayslut'] = 1
																			gs 'zz_funcs', 'cum', 'face'
																			gs 'zz_funcs', 'cum', 'anus'
...
if $args[0] = 'incest_dialog3':
	*clr & cla
	...
	$npc['38,wedding'] = 3
	gs 'stat'
	gs 'zz_render', '', '','\\\- Ой, Светик, чо скажу! МЫ! С МИШКОЙ! СЪЕЗЖАЕМСЯ!///**\\- Круто! Вот это новость! Ну чо, поздравляю,//- вы обняли сестру, которая вся прямо-таки лучилась от счастья.'
	act'Отойти': gt $loc, $metka
end
												...
												*clr & cla
												...
												act'Далее':
													*clr & cla
													minut += 5
													gs 'stat'
													gs 'zz_render', '', 'pavlovo/family/incest/event14/12.jpg','Когда ваше тело наконец перестало извергать жидкости, а вы еле удерживались на Мишкином теле, он ухватил вас за бедра и медленно стал двигатся:**\\\- Светик, ты там как? Живая?///**\\- Н-не з-знаю,//- заплетающимся языком пролепетали вы.**\\\- Давай тогда я тебе в ротик спущу!///'
													act'Далее':
														*clr & cla
														minut += 5
														gs 'stat'
														...
														act'Далее':
															*clr & cla
															minut += 5
															gs 'stat'
															gs 'zz_render', '', 'pavlovo/family/incest/event14/14.jpg','Усевшись на попу рядом со стоящим парнем, вы осмотрелись вокруг, оценивая объем предстоящей вам работы:**\\- Надеюсь у тебя есть чистящее средство.//**\\\- Ээ, найдется, наверно,//- неуверенно пробормотал Миша, потом хмыкнул,\\\- да ты так, Светик, не переживай, я уборщицу вызову.///**\\- Не-не-не, сама затопила, сама и убирать буду,//- мотая головой, настояли вы.'
															act'Далее':
																*clr & cla
																minut += 30
																gs 'stat'
