! создание NPC
if $args[0] = 'init':
	! для всех нпс добавляем счетчик болтовни $npc['0,talk_count'], в день не более 3 раз
	!
	...
	$npc['46,silavag'] = 2
	$npc['46,know'] = 0
	!-- НПС заменен на Демаркуса --!
	$npc['47,name'] = 'Демаркус'
	$npc['47,surname'] = ''
	$npc['47,nickname'] = 'Марки'
	$npc['47,relation'] = 40
	$npc['47,group'] = 8
	$npc['47,dick'] = 25
	$npc['47,sex'] = 1
...
if $args[0] = 'get_npc_text':
	if args[1] = 1: $result = 'Димка - красавчик, да ещё и "с деньгами" - сынок "олигарха", о котором вздыхает большинство девчонок в классе.'
	if args[1] = 2: $result = 'Артём - типичный ботан и отличник. Ваш сосед по подъезду. Нудный и скучный - аж скулы сводит. Но очень умный.'
	...
	if args[1] = 5: $result = 'Федька - неплохой спортсмен, друг Ваньки Прохорова.'
	...
	if args[1] = 12: $result = 'Юля - старательная и молчаливая девчонка, живущая в вашем подъезде. Круглая отличница. Высокомерная, хамоватая. Почти ни с кем не общается.'
	if args[1] = 13:
	...
	if args[1] = 14: $result = 'Огненно-рыжая миниатюрная девушка, симпатичная, неглупая, но в общем-то ничем не примечательная. У неё есть сестра-близнец Вика. Вика и Катя близнецы не только внешне, но ещё и по знаку Зодиака - они родились в конце мая. Но по характеру они - как две стороны одной медали. Катя - достаточно тихая и рассудительная девочка, застенчивая, часто и густо краснеющая по любому поводу, хотя и общается вместе с сестрой в основном с “крутыми”. В компании молчит, с отличие от вечно тарахтящей без умолку сестры, но зато знает всё про всех. Катя - тихая, стеснительная, замкнутая, любящая читать, и, обычно, стоя с сестрой в компании “крутых”, лишь загадочно улыбается, думая о чём-то своём. В общении никого особо не выделяет, поддерживая со всеми ровные отношения. Она вместе с сестрой частенько тусит на дискотеке, но на фоне Вики почти незаметна. Какие тараканы бродят в Катиной хорошенькой рыжей головке - неведомо: их она никому не показывает.'
	if args[1] = 15: $result = 'Вика - прямая противоположность своей сестры: хитрожопая и бойкая девица «себе на уме». Учится хорошо. Со всеми поддерживает ровные отношения. Вика дружит с Иваном Прохоровым из вашей школы. Вика весёлая и заводная, страстно любит танцевать, и её очень часто можно встретить на дискотеке, как правило вместе с сестрой. Она обожает яркую одежду чумовых расцветок, но они ей идут: она сама яркая как фонарик и заводная как юла. Вика и Катя близнецы не только внешне, но ещё и по знаку Зодиака - они родились в конце мая. Но по характеру они - как две стороны одной медали. В детстве Вика ходила на спортивную гимнастику, и отличается отменной гибкостью. Она взбалмошная, и никогда не знаешь - что придёт ей в голову в следующий момент. Настроение у неё меняется совершенно непредсказуемо. Логика никогда не была Викиной сильной стороной: она живёт эмоциями и чувствами, а решения принимает чаще левой пяткой, а не головой, но эта её живость и непосредственность и открытая яркая улыбка очень к ней располагают.'
	if args[1] = 16: $result = 'Наташа - ваша соседка по подъезду. Хорошо учится и очень замкнута.'
	if args[1] = 17: $result = 'Инна - высокая девушка "фотомодельных статей", молчаливая и о чём она думает - никому не ведомо.'
	if args[1] = 18:
		if $npc['18,qwZverevaSlut'] = 2:
			$result = 'Кристина, после того как отхватила люлей от вас, сломлена и унижена. Недостачу зубов после неудачи с вашей подставой она быстенько восполнила. Интересно: чтобы заплатить стоматологу она квартиру или почку продала?'
		elseif $npc['18,qwZverevaSlut'] = 1:
			$result = 'Кристина после того как отловила люлей от вас - сломлена и унижена.'
		else
	...
	if args[1] = 19: $result = 'Лина - неплохая спортсменка. Она во всём слушается Кристину Звереву.'
	if args[1] = 20: $result = 'Ленка - двоюродная сестра Витька Котова, агрессивного гопника, и сама недалеко ушла от брата, являясь заводилой девчонок-хулиганок.'
	...
	if args[1] = 25:
		if $npc['25,qwSonya'] >= 5:
			$result = 'Соня однажды неосторожно напилась на дискотеке и ее трахнули в рот по кругу Витёк Котов с дружками. После этого девчонки сторонятся её, а пацаны постояннно подкатывают с недвусмысленными предложениями. Местная гопота тоже постоянно подкатывает к Соне с "конкретными предложениями" о перепихоне или "взять на клыка".'
		else
	...
	if args[1] >= 200 and args[1] < 399:
		...
		elseif $npc['<<_npc_i>>,boy_tits'] = 2 or $npc['<<_npc_i>>,boy_tits'] = 3:
			$_npc_str[11] = 'средней'
		elseif $npc['<<_npc_i>>,boy_tits'] = 4:
			$_npc_str[11] = 'большой'
		else
			$_npc_str[11] = 'внушительной'
		end
		$result = $npc['<<_npc_i>>,name'] + ' выглядит ' + $_npc_str[val($npc['<<_npc_i>>,boy_character'])] + ' молодым человеком, одетым в ' + $_npc_str[val($npc['<<_npc_i>>,boy_type'])-3] + '.**'
...
if $args[0] = 'make_npc_group':
	...
	! 200 - уехала в сити
	if i = 14 and ($npc['14,homeward'] = 0 or ($loc = 'gdkin' and $npc['14,qwKatya_disco'] = 1)): jump 'markgruploop'
	!--
	if $npc['<<i>>,group'] = args[1]: $zz_str += func('npc_editor','get_npc_link',i) + iif(args[3]=1,', ','**')
...
if $args[0] = 'relation_list':
	i = 1
	! формируем вывод в 2 колонки
	$_column[0] = ''
	$_column[1] = ''
	:loop_relation_list
	if $npc['<<i>>,know'] = 1:
		_cur_col = i mod 2
		$_column[_cur_col] += '<tr class="relation_list_container">'
			$_column[_cur_col] += iif($settings['cheats']=0,'','<td class="relation_list_cheat" rowspan=2><a href="exec:gs''npc_editor'',''change_rep'',''-'',<<i>>,5,0,1 & gt''menu_description'',''tabs'',3"><img src="images/common/icons/down.png"></a></td>')
			$_column[_cur_col] += '<td class="relation_list_photo" rowspan=2><img src="images/common/npc/<<i>>.jpg"></td>'
			$_column[_cur_col] += '<td class="relation_list_item">' + $npc['<<i>>,name'] + ' ' + $npc['<<i>>,surname'] + '</td>'
			$_column[_cur_col] += iif($settings['cheats']=0,'','<td class="relation_list_cheat" rowspan=2><a href="exec:gs''npc_editor'',''change_rep'',''+'',<<i>>,5,0,1 & gt''menu_description'',''tabs'',3"><img src="images/common/icons/up.png"></a></td>')
		$_column[_cur_col] += '</tr>'
		$_column[_cur_col] += '<tr>'
			$_column[_cur_col] += '<td class="relation_list_scale">' + func('zz_funcs','scale',val($npc['<<i>>,relation']),100,0) + '</td>'
		$_column[_cur_col] += '</tr>'
		$_column[_cur_col] += '<tr><td colspan=4 class="relation_list_separator"></td></tr>'
	end
	i += 1
	if i < npc_arrsize: jump 'loop_relation_list'
	! собираем табличку
	gs 'zz_render','','','<center><table width=800 cellpadding=0 cellspacing=1 border=0><tr><td align=center><table>'+$_column[0]+'</table></td><td align=center><table>'+$_column[1]+'</table></td></tr></table></center>'
	killvar '$_column'
	killvar '_cur_col'
end
! ---
...
if $args[0] = 'reset_talking':
	_reset_i = 1
	:loop_reset_talking
	if _reset_i < npc_arrsize:
		$npc['<<_reset_i>>,talk_count'] = 0
		_reset_i += 1
		jump 'loop_reset_talking'
	end
	killvar '_reset_i'
end
!---
...
! args[1] - id НПС
! $args[2] - локация диалогов с НПС
! $args[3] - аргумент локации диалогов с НПС
if $args[0] = 'check_dialogs':
	local _cur_npc_id = args[1]
	local _talk_result = 0
	! локации для перехода на диалог с нпс
	$_npc_dialog_loc = $args[2]
	$_npc_dialog_arg = $args[3]
	! result - желание разговаривать с ГГ:
	!	0 - не хотят
	!	1 - разговор доступен
	!-----------------------
	! заполняем массив статусов
	! все эффекты - по 3 записи
	!---
	! негативные эффекты
	! реакция на сперму на лице и/или одежде
	! гопники, отношения до 60
	$_status[0] = '\\\- Шмара, кто тебя так уделал?///'
	$_status[1] = '\\\- Шмара, улыбнись, фотку сделаю - будет что пацанам показать!///'
	$_status[2] = '\\\- Хуесоска, че привалила? Катись отсюда!///'
	! гопники, отношения больше 60
	$_status[3] = '\\\- Света, кто тебя так уделал? Вытрись чтоли.///'
	$_status[4] = '\\\- Света, приведи себя в порядок - смотреть противно на всю эту кончу.///'
	$_status[5] = '\\\- Света, я, конечно, все понимаю, но болтаться в таком виде?.. Не-не, отвали.///'
	! другие нпс, отношения до 60
	$_status[6] = '\\\- Шлюшка, приведи себя в порядок!///'
	$_status[7] = '\\\- Да вы только посмотрите - даже не скрывается, шлюха подзаборная!///'
	$_status[8] = '\\\- Вот же дрянь! Как в таком виде на людях показываться?///'
	! другие нпс, отношения больше 60
	$_status[9] = '\\\- Света, ты чего творишь? Приведи себя в порядок!///'
	$_status[10] = '\\\- Света, и не стыдно тебе в таком виде среди людей расхаживать?///'
	$_status[11] = '\\\- Фу, Светка, мерзко же, вытрись!///'
	!---
	! реакция на запах спермы
	$_status[12] = '\\\- Фу, иди почисти зубы - воняет, как с канализации!///'
	$_status[13] = '\\\- Фу, Светка, о жвачках не слыхала, чтоли?///'
	$_status[14] = '\\\- Фу, не воняй здесь, иди попей хоть чего!///'
	!---
	! реакция на жирность, только для отношений до 60
	$_status[15] = '\\\- Здесь бутерброды не раздают!/// - язвит по поводу вашей фигуры ' + $npc['<<_npc_id>>,name']
	$_status[16] = '\\\- Разойдись народ, пока Светка вас не затоптала!/// - язвит по поводу вашей фигуры ' + $npc['<<_npc_id>>,name']
	$_status[17] = '\\\- Худеть не пробовала? Диеты там, бег?/// - язвит по поводу вашей фигуры ' + $npc['<<_npc_id>>,name']
	! реакция на волосатость ног
	$_status[18] = '\\\- Побрей ноги, дуреха - не пугай людей!///'
	$_status[19] = '\\\- Не стыдно с такой шерстью юбку носить?///'
	$_status[20] = '\\\- Ты б хоть брюки одела и не отсвечивала своей волосатостью.///'
	! реакция на потность
	$_status[21] = '\\\- Фу, от тебя несет, как от вокзалной бомжихи!///'
	$_status[22] = '\\\- Фу, Светка, дорогу в душ забыла?///'
	$_status[23] = '\\\- Фу, Светка, мыться надо иногда!///'
	! реакция на простуду
	$_status[24] = '\\\- Ты чего в таком виде гуляешь? Иди домой, лечись.///'
	$_status[25] = '\\\- Ты б к врачу сходила, чтоли...///'
	$_status[26] = '\\\- Эй, не надо рассевать свои бактерии возле меня!///'
	! реакция на плохую репутацию, отношения до 60
	$_status[27] = '\\\- Эй, шлюшка, отвали! Еще подумают, что мы дружим!///'
	$_status[28] = '\\\- Че надо, шлюшка? Отвали, некогда с такими, как ты, болтать.///'
	$_status[29] = '\\\- И какого хрена надо? Отвали, дрянная шлюха!///'
	! реакция на плохую репутацию, отношения больше 60
	$_status[30] = '\\\- Привет, Света, как твои развратные делишки?/// - подшучивает над вами ' + $npc['<<_npc_id>>,name']
	$_status[31] = '\\\- Привет, Света, как дела на половом фронте?/// - шутит ' + $npc['<<_npc_id>>,name']
	$_status[32] = '\\\- Привет, Света, скажи по секрету - в какой позе больше нравится?/// - подкалывает вас ' + $npc['<<_npc_id>>,name']
	! реакция на сильное опьянение
	$_status[33] = '\\\- А кто это у нас тут наклюкался? Или, точнее, нажрался?///'
	$_status[34] = '\\\- Фигасе, как ты еще ходишь-то? Иди проспись.///'
	$_status[35] = '\\\- Ты чего в таком виде гуляешь? Иди домой, пьянь.///'
	! позитивные эффекты
	! реакция на прическу
	$_status[36] = '\\\- Светка, классная прическа, мне нравится!///'
	$_status[37] = '\\\- Светка, где такую прическу сделала? Круто выглядит!///'
	$_status[38] = '\\\- Светка, может и мне такую прическу сделать, что скажешь?/// - шутит ' + $npc['<<_npc_id>>,name']
	! реакция на макияж
	$_status[39] = '\\\- Светка, а тебе идет этот цвет теней!///'
	$_status[40] = '\\\- Светка, куда это ты так накрасилась-напомадилась?///'
	$_status[41] = '\\\- Спецагент Светка в боевом марафете вышла на задание/// - шутит ' + $npc['<<_npc_id>>,name']
	! реакция на модную одежду
	$_status[42] = '\\\- Света, шикарное платье! Дорогое, наверное...///'
	$_status[43] = '\\\- Света, платье где стащила? Тебе очень идет!///'
	$_status[44] = '\\\- Света, а ты, как оказывается, умеешь красиво одеваться!///'
	! обычные приветствия
	$_status[45] = '\\\- Привет, Света, как дела?///'
	$_status[46] = '\\\- Привет, Света, как поживаешь? Что расскажешь?///'
	$_status[47] = '\\\- Привет, Света, где бывала, что видела?///'
	!---
	! механика
	! если ГГ ходи со спермой на лице, одежде или с запахом изо рта - штраф в репутацию, дальнейший диалог невозможен
	if cumface + cumfrot + cumlip > 0:
		if cumface > 0 or cumfrot > 0:
			if $npc['<<_cur_npc_id>>,group'] = 4:
				gs 'zz_render','','',$_status[iif($npc['<<_cur_npc_id>>,relation'] < 60,rand(0,2),rand(3,5))]
			else
				gs 'zz_render','','',$_status[iif($npc['<<_cur_npc_id>>,relation'] < 60,rand(6,8),rand(9,11))]
			end
		elseif cumlip > 0:
			gs 'zz_render','','',$_status[rand(12,14)]
		end
		gs 'zz_reputation','edit', -5
		_talk_result = 0
	elseif func('zz_reputation','get') >= 3:
		gs 'zz_render','','',$_status[iif($npc['<<_cur_npc_id>>,relation'] < 60,rand(27,29),rand(30,32))]
		_talk_result = iif($npc['<<_cur_npc_id>>,relation'] < 60,0,1)
	else
		! статусы не закрывают возможность поболтать,
		! складываем в массив, а потом выводим один из них
		if body['group'] >= 3 and $npc['<<_npc_id>>,relation'] < 60:
			$_res_status[arrsize('$_res_status')] = $_status[rand(15,17)]
		elseif leghair > 2:
			$_res_status[arrsize('$_res_status')] = $_status[rand(18,20)]
		elseif sweat > 1:
			$_res_status[arrsize('$_res_status')] = $_status[rand(21,23)]
		elseif sick > 1:
			$_res_status[arrsize('$_res_status')] = $_status[rand(24,26)]
		elseif alko >= 6:
			$_res_status[arrsize('$_res_status')] = $_status[rand(33,35)]
		end
		! если в результирующем массиве что-то есть - понижаем отношения
		if arrsize('$_res_status') > 0:
			gs 'npc_editor','change_rep','-',_cur_npc_id,1
		else
			! если результирующий массив негативных эффектов пуст - заполняем позитивными
			if curly > 0: $_res_status[arrsize('$_res_status')] = $_status[rand(36,38)]
			if mop > 1: $_res_status[arrsize('$_res_status')] = $_status[rand(39,41)]
			if func('zz_clothing2','get_group') = 5: $_res_status[arrsize('$_res_status')] = $_status[rand(42,44)]
			$_res_status[arrsize('$_res_status')] = $_status[rand(45,47)]
		end
		gs 'zz_render','','',$_res_status[rand(0,arrsize('$_res_status')-1)]
		_talk_result = 1
	end
	act '<b>Отойти</b>': gt $loc,$metka
	if _talk_result = 1 and $npc['<<_cur_npc_id>>,talk_count'] < 3:
		act 'Болтать':
			$npc['<<_cur_npc_id>>,talk_count'] += 1
			gt $_npc_dialog_loc,$_npc_dialog_arg
		end
	end
	killvar '$_status'
	killvar '$_res_status'
	killvar '_cur_npc_id'
	killvar '_talk_result'
end