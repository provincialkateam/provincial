...
if $args[0] = 'preg_talk2': $result = 'Парень задумался:**\\\- Слушай, я не готов стать отцом, да ещё и жениться на тебе.///**Он протянул вам пять тысяч:**\\\- Возьми деньги, и давай расстанемся.///'
...
if $args[0] = 'preg_talk5': $result = 'Парень возмутился:**\\\- Да ты охуела, шалава! Кому-то подставила свою манду, а теперь будешь с меня бабки качать? Да пошла ты нахуй!///'
...
if $args[0] = 'boy_talk4': $result = '<<$nameBoyfrend[numnpc]>> усмехнувшись, сказал:**\\\- Да расслабься! Ты же и есть самая настоящая <<$gnikname>> - чего такого-то?///'
...
if $args[0] = 'boy_walk1': $result = 'Вы видите, что вам навстречу идет Витёк Котов. Он подходит к парню и без прелюдий бьёт его по лицу. <<$nameBoyfrend[numnpc]>> падает на землю. Витёк наклоняется над ним:**\\\- Слышь, ты, уёбок, это моя девчонка! Ещё раз увижу тебя с ней - живым в лесу закопаю, понял?/// - парень кивает головой и заверяет, что понял.'
