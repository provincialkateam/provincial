if $args[0] = '':
	*clr & cla
	...
	gs 'npc_editor','check_dialogs',numnpc,'Snpc','dialogs'
	gs 'gnpc_events','mock'
end
!---
if $args[0] = 'dialogs':
	*clr & cla
	...
	if numnpc = 14:
		...
		if $npc['14,qwKatya_day'] ! day:
			...
			!--
			if $npc['14,qwKatya'] >= 75 and $npc['14,qwKatya'] < 82 and $loc = 'gdkin': act 'Спросить о планах': gt 'mey_katya_events','random_hotel_sex'
			!---
		end
