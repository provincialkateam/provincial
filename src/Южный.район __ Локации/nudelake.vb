...
if katday ! day and $npc['33,relation'] > 40 and cloth[0] = 0 and lake_people > 2: gs 'zz_render', '', '','На пляже загорает <a href="exec: gt''Katlake'',''kat''">Кэт</a>.'
if anutaday ! day and anutaQW = 2 and cloth[0] = 0 and lake_people > 2: gs 'zz_render', '', '','Вы видите '+iif(anuta['horny'] < 70,'загорающую на пляже','бредущую по пляжу, подвыпившую')+' <a href="exec: gt''anuta''">Анюту</a>.'
...
act 'Уйти':
	if cloth[0] > 0 or (cloth[0] = 0 and exhibi > 0):
		...
		gs 'zz_render','','','<b><font color = red>Вы не можете разгуливать голышом среди такого количества людей.</font></b>'
	end
end