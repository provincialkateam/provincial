...
!============================================================================================================!
	...
	gs 'zz_render','','images/zsoft/pod_ezd/shulgahome/korr.jpg'
	...
	act 'Идти в ванную':
		...
		gt 'zz_bathroom','init','shulgahome'
	end
...
$shkuh = {
	*clr & cla
	...
	if RAND(0,20) <= 5 and func('zz_reputation','get') >=3 and gangsexroom_count > 0 and week < 6 and hour >= 0 and hour < 3:
