	...
	*clr & cla
	...
	if money >= 1000:
		if $settings['hapri_mod'] = 1:
			...
			if shorthair <= 2: $_str += '**<a href="exec: gt ''barbershop'', ''hair_medium_short'' ">Короткая прическа - 1 тыс.руб</a>'
			if shorthair <= 1: $_str += '**<a href="exec: gt ''barbershop'', ''hair_medium''">Средняя прическа - 1 тыс.руб</a>'
			$_str += '**<a href="exec: gt ''barbershop'', ''hair_coloring'' ">Покрасить волосы - 1 тыс.руб</a>**'+iif(shorthair < 3,'<a href="exec: gt ''barbershop'', ''hair_curl'' ">Завить волосы - 1 тыс.руб</a>','Завить волосы - 1 тыс.руб')
		else
			$_str = '<a href="exec: gt ''barbershop'', ''hair_short'' ">Короткая прическа - 1 тыс.руб</a>**<a href="exec: gt ''barbershop'', ''hair_coloring'' ">Покрасить волосы - 1 тыс.руб</a>'
			$_str += '**'+iif(shorthair = 0,'<a href="exec: gt ''barbershop'', ''hair_curl'' ">Завить волосы - 1 тыс.руб</a>','Завить волосы - 1 тыс.руб')
		end
	else
		$_str = '**Короткая прическа - 1 тыс.руб**Окрашивание волос 1 тыс.руб**Завить волосы - 1 тыс.руб'
	end
