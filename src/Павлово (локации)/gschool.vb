...
if hour >= 9 and hour < 15 and school['certificate'] = 0 and month = 8:
	gs 'zz_render', '', '', func('gschool_strings', 'local_str35')
	act 'На отработку':
		*clr & cla
		hour = 15
		gs 'zz_render', '', '/pavlovo/school/summer_work'+rand(1,3), func('gschool_strings', 'local_str36')
		gs 'stat'
		act 'Уйти':
			gt $curloc
		end
...
if (hour >= 7 and hour <= 15) and week < 6 and school['certificate'] = 0 and school['vacation'] = 0:
	if func('zz_clothing2','is_schooldress') = 1:
		act 'Идти в школу':
...
if hour >= 15 and hour <= 17 and absent['stage'] = 5:
	act 'Идти отрабатывать прогулы': gt 'absent_events','gt_director_home'
end
