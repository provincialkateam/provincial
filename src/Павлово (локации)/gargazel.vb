...
if $father['location'] = $loc and hour >= 18 and hour <= 20:
	...
	if hour = 20:
		gs 'zz_render','','','Сейчас <a href="exec:GT ''garfather''">отчим c дядей Мишей</a> в гараже пьют водку.'
		fatherdrunk = 1
	else
		gs 'zz_render','','','Сейчас <a href="exec:GT ''garfather''">отчим</a> в гараже, чинит машину.'
	end
else
