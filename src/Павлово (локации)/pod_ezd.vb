...
if $ARGS[0] = 'etaj_1':
	*clr & cla
	...
	act 'Подняться по лестнице на второй этаж': gt 'pod_ezd','etaj_2'
	act '<b>Выйти на улицу</b>': gt 'gorodok'
	act '<b>Во двор</b>': gt 'ghomeyard'
end
! Доска объявлений
if $args[0] = 'board':
	*clr & cla
	...
	*clr & cla
	...
	act 'Квартира тети Люды':
		*clr & cla
		...
		if tetyafirst < 2 and week >= 6 and hour > 19 or oluuosegunday_count = 0 and week >= 6 and hour > 19: gs 'zz_render', '', '', 'Вам открыла дверь тетя Люда и сказала:**\\\- Света извини я сейчас не могу разговаривать, у меня гость.///'
		if tetyafirst < 2 and week < 6 and hour > 19 or oluuosegunday_count = 0 and week < 6 and hour > 19: gs 'zz_render', '', '', 'Вам открыла дверь тетя Люда и сказала:**\\\- Света извини я сильно занята, не могу сейчас уделить тебе время.///'
