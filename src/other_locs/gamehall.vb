...
if $args[0] = 'play':
	...
	act 'Дернуть рычаг':
		if money >= _bet:
			...
			*clr
			$_img = 'images/common/gamehall/game_box/'
			gs 'zz_render','','','<center><img src="<<$_img>>fon_t_a_<<_bet>>.jpg"><table border=0 cellpadding=0 cellspacing=0><tr><td rowspan="4"><img src="<<$_img>>fon_c_a.jpg"></td><td rowspan="4"><img src="<<$_img>><<b1>>.gif"></td><td rowspan="4"><img src="<<$_img>>game_box/fon_c_b.jpg"></td><td rowspan="4"><img src="<<$_img>><<b2>>.gif"></td><td rowspan="4"><img src="<<$_img>>fon_c_b.jpg"></td><td rowspan="4"><img src="<<$_img>><<b3>>.gif"></td></tr><tr><td><img src="<<$_img>>fon_c_c_a_<<_bet>>.jpg"></td></tr><tr><td><img src="<<$_img>>fon_c_c_b_<<i>>.jpg"></td></tr><tr><td><img src="<<$_img>>fon_c_c_c_<<img_win>>.jpg"></td></tr></table><center><img src="<<$_img>>fon_b_a.jpg">'
			killvar '$_img'
			gs 'stat'
		else
