! начальная строка
gs 'zz_render','','pavlovo/family/brother/porn_view/after_2/1.webm', func('porn_view_strings', 'init0')
...
if $npc['39,qwPornoFootball'] < 10:
	if (sex + bj + hj + anal + kuni) = 0:
		...
		if $npc['39,qwPornoFootball'] = 0:
			gs 'zz_render', '', '', func('porn_view_strings', 'view_1_virgin')
			$npc['39,qwPornoFootball'] += 1
			cla
			act 'Уйти': gt 'gorodok'
		elseif $npc['39,qwPornoFootball'] > 0 and $npc['39,qwPornoFootball'] < 3:
			gs 'zz_render', '', '', func('porn_view_strings', 'view_2_virgin')
		...
		elseif $npc['39,qwPornoFootball'] = 3 or $npc['39,qwPornoFootball'] = 4:
			gs 'zz_render', '', '', func('porn_view_strings', 'view_3_virgin'+iif(horny > 70,'_horny',''))
			$npc['39,qwPornoFootball'] +=1
			horny += 10
			cla
			act 'Уйти': gt 'gorodok'
		elseif $npc['39,qwPornoFootball'] = 5 or $npc['39,qwPornoFootball'] = 6:
			gs 'zz_render', '', '', func('porn_view_strings', 'view_'+$npc['39,qwPornoFootball']+'_virgin'+iif(horny > 70,'_horny',''))
			$npc['39,qwPornoFootball'] += 1
			horny += 10
			cla
			act 'Уйти': gt 'gorodok'
		elseif $npc['39,qwPornoFootball'] >= 7 and $npc['39,qwPornoFootball'] < 10:
			gs 'zz_render', '', '', func('porn_view_strings', 'view_7_virgin'+iif(horny > 70,'_horny',''))
			$npc['39,qwPornoFootball'] +=1
			horny += 10
			if cloth[1] = 0:
				act '...':
		...
		if $npc['39,qwPornoFootball'] < 3:
			gs 'zz_render','','', func('porn_view_strings', 'view_1')
			$npc['39,qwPornoFootball'] += 1
			cla
			act 'Уйти': gt 'gorodok'
		elseif $npc['39,qwPornoFootball'] = 3 or $npc['39,qwPornoFootball'] = 4:
			gs 'zz_render', '', '', func('porn_view_strings', 'view_3'+iif(horny > 70,'_horny',''))
			$npc['39,qwPornoFootball'] += 1
			cla
			act 'Уйти': gt 'gorodok'
		elseif $npc['39,qwPornoFootball'] = 5:
			gs 'zz_render', '', '', func('porn_view_strings', 'view_5'+iif(horny > 70,'_horny',''))
			! а есть ли труселя
			if cloth[1] = 0: gs 'zz_render', '', '', func('porn_view_strings', 'view_5'+iif(horny > 70,'_horny_no_tanga','_no_tanga'))
			$npc['39,qwPornoFootball'] += 1
			cla
			act 'Уйти': gt 'gorodok'
		elseif $npc['39,qwPornoFootball'] = 6:
			...
			! а есть ли труселя
			if cloth[1] = 0: gs 'zz_render', '', '', func('porn_view_strings', 'view_6'+iif(horny > 70,'_horny_no_tanga','_no_tanga'))
			act '...':
				*clr & cla
		...
		elseif $npc['39,qwPornoFootball'] >= 8:
			act '...':
				*clr & cla
				...
				gs 'zz_render', '', '', func('porn_view_strings','view_8'+iif(cloth[1]=0,'_no_tanga','_tanga'))
		...
		act '...':
			*clr & cla
			...
			if horny > 70:
				...
				gs 'zz_render', '', '', func('porn_view_strings', 'view_13_no_horny')
				act 'Уйти': gt 'gorodok'
			end
		end
	elseif $npc['39,qwPornoFootball'] = 14:
		act '...':
			*clr & cla
			...
			gs 'zz_render', '', '', func('porn_view_strings', 'view_14'+iif(cloth[1]=1,'_tanga','_no_tanga'))
	...
	elseif $npc['39,qwPornoFootball'] = 15:
		act '...':
			*clr & cla
			...
			act '...':
				*clr & cla
				gs 'zz_render', '', 'images/pavlovo/family/brother/porn_view/after_3/3.webm', func('porn_view_strings', 'view_15_prev2')
				act '...':
					*clr & cla
...
!мать его так - не понимает больше вложенности
			...
			act '...':
				*clr & cla
				...
				if vagina > 0:
					...
					if tabletki = 0 and condom = 0: gs 'zz_render', '', '', func('porn_view_strings', 'view_22_no_pills')
					act '...':
						*clr & cla
				...
				if vagina > 0:
					act '...':
						*clr & cla
						...
						act '...':
							*clr & cla
							gs 'zz_funcs','set_gape','vagina',horny, 15, 0
	...
	elseif $npc['39,qwPornoFootball'] = 31:
		act '...':
			...
			*clr & cla
			...
			if stat_vgape > 0: gs 'zz_render', '', '', func('porn_view_strings', 'view_31_vpain')
			if mesec > 0 or stat_vgape > 0:
				if anus = 0:
					act '...':
						*clr & cla
	...
	elseif $npc['39,qwPornoFootball'] >= 32 and $npc['39,qwPornoFootball'] <= 35:
		act '...':
			*clr & cla
			gs 'zz_render','','pavlovo/family/brother/porn_view/after_3/8.webm'
	...
	if $npc['39,qwPornoFootball'] = 36:
		act '...':
			*clr & cla
			gs 'zz_render', '', 'pavlovo/family/brother/porn_view/after_3/8.webm', func('porn_view_strings', 'view_36')
			act '...':
				*clr & cla
			...
			if mesec > 0:
				...
				act '...':
					*clr & cla
					...
					if tabletki = 0 and condom = 0: gs 'zz_render', '', '', func('porn_view_strings', 'view_cum_in_mind'+rand(0,2))
