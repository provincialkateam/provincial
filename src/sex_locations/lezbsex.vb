...
if $ARGS[0] = 'var':
	...
	if picrand ! 12 and picrand ! 13 and picrand ! 14 and picrand ! 16 and picrand ! 17 and picrand ! 18:
		act 'Анулингус':gt'lezbsex','lezb_variant','anuli'
		act 'Сделать анулингус':gt'lezbsex','lezb_variant','uanuli'
	end
	if strapon = 1 and picrand ! 11 and picrand ! 12 and picrand ! 13 and picrand ! 14 and picrand ! 15 and picrand ! 16 and picrand ! 17 and picrand ! 18 and picrand ! 19 and picrand ! 20 and picrand ! 22:
	...
	if dildo = 1 and picrand ! 12 and picrand ! 19 and picrand ! 20 and picrand ! 22:
		...
		if picrand ! 11 and picrand ! 15 and picrand ! 16 and picrand ! 17 and picrand ! 18: act 'Дилдо в попку':gt'lezbsex','lezb_variant','danal'
		if picrand ! 11: act 'Дилдо вам в киску':gt'lezbsex','lezb_variant','udvag'
		if picrand ! 11 and picrand ! 14 and picrand ! 15 and picrand ! 16 and picrand ! 17 and picrand ! 18:act 'Дилдо вам в попу':gt'lezbsex','lezb_variant','udanal'
	end
end
if $args[0] = 'lezb_variant':
	*clr & cla
	...
	gs 'zz_render','','img/lezbsex/' + $args[1] + picrand
...
if $ARGS[0] = 'end':
	cla
	if picrand = 22: gt'center'
	if picrand = 19 or picrand = 20:gt'office','work'
	if $npc['31,sex'] = 1: gt 'fitness','dressroom'
	gt '<<$sexloc>>','start'
end