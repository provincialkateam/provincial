...
if cloth[3] > 2: gs 'zz_render', '', '','На вешалке висит ваша <a href="exec: gt ''grandparents_events'',''dress_after_sauna''">одежда</a>'
if mira = 0:
	act 'Выйти во двор':
		if cloth[3] > 2 or cloth[3] >= 0 and shameless['flag'] > 2:
			minut += 5 & gt'Gaddvor'
		else
			*clr & cla
