...
if boletus > 0 or bilberry > 0:
	act 'Засушить грибы и ягоды(продукты)':
		*clr & cla
		...
		boletus = 0
		bilberry = 0
		gs 'zz_render','Изба','images/gadukino/grandparents_house/house/dried_mushrooms.jpg','Посчитав, что вам нужны продукты, вы отправили на сушку найденные грибы и ягоды.'
