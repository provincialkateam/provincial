...
if func('zz_weather','is_day') = 1 and month >= 4 and month <= 10:'По двору ходят <a href="exec: gt ''grandparents_events'',''chickens'' ">куры</a>'
...
if meadow > 0 and func('zz_weather','is_day') = 1 and snow <= 0 and mira_guest = 0:act 'Иди на поляну':minut += 20 & gt'Meadow'
if cloth[0] > 2:act '<b>Идти в деревню</b>':mira_guest = 0 & minut += 5 & gt 'gadukino'
...
if cloth[0] = 0: gt 'grandparents_events','courtyard_nude'