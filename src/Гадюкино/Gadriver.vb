...
if fishers = 1 and func('zz_weather','is_day') = 1:'На берегу раскинули свои удочки местные <a href="exec: gt ''river_events'',''fishers'' ">рыбаки</a>.'
...
if cloth[0] = 0:gt 'gadukino_event', 'gadriver_nude'
if mitkasextimes = 20 and func('zz_weather','is_day')=1 and month >= 5 and month <= 9 and sunWeather >= 0 and temper >= 20:gt 'gadukino_event', 'gadriver_gang'
