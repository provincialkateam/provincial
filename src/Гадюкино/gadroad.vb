...
if func('zz_clothing2','get_group') = 1 and hour >= 6 and hour < 21 and daybegskver ! daystart and sunWeather >= 0:
	if sick > 0:
		gs 'zz_render','','','<red>Вы болеете, поэтому заниматься физическими упражнениями совсем не хочется.</red>'
		exit
	end
...
if cloth[0] < 3:act 'Пробраться в деревню огородами':gt'gadukino_event','gadukino_back'
