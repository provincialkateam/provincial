if $ARGS[0] = 'garden':
	...
	*clr & cla
	...
	if cloth[0] = 0: gt 'grandparents_events','garden_nude'
end
if $ARGS[0] = 'strawberry':
	...
	*clr & cla
	...
	gs 'zz_render', $_str, 'qwest/gadukino/new/strawberry'+iif(func('zz_weather','is_day')=1,iif(month = 6 or month = 7,1,2),'_night')+'.jpg','Клубничная делянка на которой, в сезон, можно вырастить немного клубники.'
		...
		act 'Собирать клубнику':
			*clr & cla
			...
			if func('zz_clothing2','is_skirt') = 0:
				...
				gs 'zz_render', $_str, 'qwest/gadukino/new/collect_strawberries'+iif(cloth[1] = 1,'_ski','_tanga')+'.jpg'
			end
...
if $ARGS[0] = 'fruit_garden':
	...
	*clr & cla
	...
	gs 'time'
	$_str = 'Фруктовый сад'
	gs 'zz_render', $_str, 'qwest/gadukino/new/fruit_garden'+iif(func('zz_weather','is_day')=1,'','_night'),'Фруктовый сад в котором растут яблоки и груши.'
		...
		act 'Собирать фрукты':
			*clr & cla
			...
			if func('zz_clothing2','is_skirt') = 0:
				...
				gs 'zz_render', $_str, 'qwest/gadukino/new/fruit_collect'+iif(cloth[1] = 1,'_ski','_tanga')+'.jpg'
			end
