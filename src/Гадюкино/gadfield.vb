...
if $ARGS[0] = 'mira':
	*clr & cla
	...
	miraday = day
	gs 'stat'
	gs 'zz_render', 'Мирослава', 'qwest/gadukino/Mira2.jpg','Оторвавшись от созерцания коров, вы заметили приближающуюся к вам Миру. Вы радостно поднялись ей на встречу.**\\\- Привет,Света. А я вот решила тебя навестить и попить принести, -/// сказала она подойдя к вам.\\\ - Скучаешь небось?///'
	act 'Далее': gt $loc, $metka
end