...
if brow < 0:
	$brow = 'перманентный татуаж бровей' & brokoef = 1
elseif brow >= 0 and brow < 10:
	$brow = 'немного неаккуратные брови'
else
	$brow = 'ухоженные брови' & brokoef = 2
end
...
elseif cloth[0] > 2:
	...
	odevnesh = func('zz_clothing2','get_bonus')
end
!---
! волосатость ног не видна под джинсами, леггинсами и спорткостюмом
_cur_cloth_group = func('zz_clothing2','get_group')
if _cur_cloth_group = 1 or _cur_cloth_group = 2: legkoef = 0
