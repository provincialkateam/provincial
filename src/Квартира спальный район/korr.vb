...
if my_house = 1 or my_house = 2 and repairs_vanr = 0: act 'В ванную': gt 'zz_bathroom','init','korr'
...
act '<b><font color = maroon>НА УЛИЦУ</font></b>':gt 'apartment_south_event','go_out','south'
if parkday ! day and parkblackmail = 1:
	parkblackmail = 2
	parkday = day
	gs 'zz_render', '', '','Вам приходит по почте плотный конверт, раскрыв его вы видите фотографии. Черт, это фотки как вы делаете минет двум парням в парке.**Небольшая записка гласит:**Если не хочешь что бы эти фотки были расклеены по твоему подъезду и отосланы на твою работу, приходи по адресу (В адресе указана Фотостудия)**PS, если не придешь сегодня, завтра же фотографии будут висеть у тебя в подъезде.'
...
$phone_ring = '<red>Звонит телефон</red>'
$boy_no_call = '<red>Ваш парень вам не звонит, видимо он вас бросил.</red>'
...
$door_ring = '<red>Раздается звонок в дверь</red>'
