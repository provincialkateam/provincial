...
if dirttarelka > 0: gs 'zz_render', '', '','В раковине лежат <b><<dirttarelka>></b> штук грязных тарелок. '+iif(kransloman = 0 and fairy > 0,'<a href="exec: gt''apartment_south_event'',''dirtarm'' ">Которые можно бы и помыть</a>.','')
...
if edaD = 0 and eda = 0: gs 'zz_render', '', '','<red>В холодильнике шаром покати, вообще нечего есть.</red>'
...
if garbage > 10:
	...
	gs 'zz_render', '', '','Возле мойки стоит полное ведро мусора.'
	if cloth[0] > 2: act 'Выкинуть мусор': minut += 10 & take_out_trash = 1 & gt 'trashplace'
end
