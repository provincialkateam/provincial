...
$d_husb_discription = {
	...
	gs 'zz_render','','','Ваш муж <<$husName>>, <<$h_age>> Он <<$husBody>> <<$husFat>> <<$husHair>>.'
...
$d_husb_action = {
	...
	gs 'zz_render','','','<<$husb_action>>'
}
if $ARGS[0] = 'start':
	*clr & cla
	gs 'stat'
	gs 'zz_render','','images/pic/boy_face/<<HusbPic>>.jpg'
	dynamic $d_husb_discription
	dynamic $d_husb_action
	if cloth[0] = 0: 'Ваш муж, увидев вас голой, сказал - "Ты очень красива."'
