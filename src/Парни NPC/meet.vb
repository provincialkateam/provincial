...
if $ARGS[0] = 'start':
	...
	if mop > 1 and func('zz_clothing2','is_glamour') = 1 and curly > 0 and love = 1 and harakBoyA = 0:
		gs 'zz_render','','',func('meet_strings', 'local_str9')
		act 'Ехать к родителям':gt'love','mother'
		exit
	elseif mop > 1 and func('zz_clothing2','is_glamour') = 1 and curly > 0 and love = 1 and harakBoyA = 1 and cloth[1] = 1:
	...
	if harakBoyA = 2:$meet = '"Привет, Света! Рад тебя видеть, <<$meetmop>> <<$meethair>>"'
	$meetcol = ''
	...
	if venera < 4 and cumface = 0:
		...
		act 'Поцеловать в губы':
			*clr & cla
			gs 'stat'
			if cumlip = 0:
				gs 'zz_render','','images/pic/kiss1.jpg'
		...
		act 'Поцеловать в щеку':
			*clr & cla
			gs 'stat'
			DOM += 1
			gs 'zz_render','','images/pic/kiss2.jpg'
...
if $ARGS[0] = 'a':
	...
	if financeA = 0:
		if func('zz_clothing2','is_glamour') = 1:
			bfA -= (harakBoyA + 1)
			gs 'zz_render', '', '', func('meet_strings', 'local_str28')
		elseif func('zz_clothing2','is_skirt') = 1 or func('zz_clothing2','get_group') = 1:
			bfA += (harakBoyA + 1)
