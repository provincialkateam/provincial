...
if initi > initiV and hodtime < 3 and ionce = 0 or hodtimeV >= 3 and ionce = 0:
	...
	gs 'zz_render','','','<font color = green>Вы захватили инициативу</font>'
	ionce = 1
elseif initi < initiV and hodtimeV < 3 and ionce = 0 or hodtime >= 3 and ionce = 0:
	hod = 1
	hodtimeV += 1
	if hodtime >= 3:hodtime = 0
	gs 'zz_render','','','<font color = red><<$boy>> захватил инициативу</font>'
	ionce = 1
elseif initi = initiV and hodtime < 3 and hodtimeV < 3 and ionce = 0:
	...
	if RAND(0,1) = 0:
		hod = 0
		hodtime += 1
		gs 'zz_render','','','<font color = green>Вы перехватили инициативу</font>'
	else
		hod = 1
		hodtimeV += 1
		gs 'zz_render','','','<font color = red><<$boy>> перехватила инициативу</font>'
	end
