...
if $ARGS[0] = 'registr':
	...
	*clr
	...
	act 'Я поняла вас, мне надо подумать': gt 'north'
...
if $ARGS[0] = 'olga2':
	...
	*clr
	...
	if bumtolik = 11 and buklinikDay ! day: '- Света, тебе снова нужно отправиться к <a href="exec:GT ''misha_inv'',''entrance'',0">Михаилу</a>.'
	if bumtolik = 12 and buklinikDay ! day: '- Тебя снова ждет <a href="exec:GT ''misha_inv'',''entrance'',1">Михаил</a>.'
	if bumtolik = 13 and buklinikDay ! day: '- Света, тебя снова ждет <a href="exec:GT ''misha_inv'',''entrance'',2">Михаил</a>.'
	if bumtolik = 14 and buklinikDay ! day: '- Света, тебя ждет <a href="exec:GT ''misha_inv'',''entrance'',3">Михаил</a>.'
