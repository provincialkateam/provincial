	...
	act 'Да':
		*clr & cla
		...
		act 'Света':
			*clr & cla
			gs 'stat'
			gs 'zz_render', 'Подъезд', 'images/city/south/front_door/entryway.jpg','Вы сказали парню что вас зовут Светы. Он кивнул головой и достав ключи начал открывать дверь 68-ой квартиры:**\\\- Очень приятно. Я как видите в соседней квартире живу, 68-й. А видите '+iif(BuyHous ! 1,'70','69')+'-ю квартиру? Она '+iif(BuyHous ! 1,'продаётся','сдаётся')+'. Ну это так, для информации, вдруг понадобится.///**Парень открыл дверь и на пороге показалась любопытное лицо пожилой женщины. Она направила на вас свой острый нос и стала с любопытством осматривать.**\\\- Мам, ну хватит уже торчать перед дверью!, -/// сказал Тимофей, входя в квартиру и закрывая за собой дверь.'
