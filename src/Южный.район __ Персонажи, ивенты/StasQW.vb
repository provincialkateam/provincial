if $ARGS[0] = 'cafe':
	*clr & cla
	minut += 5
	gs 'stat'
	gs 'zz_render', '', 'images/city/south/stas/cafe_start.jpg', 'Вы сели на стул и Стас, жестом подозвав официантку, заказал бутылку вина и закуску к нему. Когда заказ принесли Стас, разлив вино по бокалам, произнёс:**\\\- Давай за знакомство!///'
									...
									*clr & cla
									...
									act 'Далее':
										*clr & cla
										minut += 5
										gs 'stat'
										gs 'zz_render', '', 'images/city/south/stas/cafe_bill.jpg', 'Наконец, когда всё было съедено и выпипито, официантка принесла счет. Вы взглянули на цифру и слегка обалдели.**\\- Пять тысяч! В этом кафе?! -// воскликнули вы глядя на счёт.**\\\- Не парься, я заплачу./// - сказал Стас забирая бумажку из ваших рук.'
	...
	if horny > 90 or shameless['flag'] > 1:
		act 'Можно и в туалете':
			*clr & cla
			minut += 5
			gs 'stat'
			gs 'zz_render', '', 'images/city/south/stas/cafe_wait.jpg', '\\- Можно и в туалете, -// согласились вы'+iif(alko >= 3,', пьяно улыбнувшись','')+'.**\\\- Хорошо, тогда иди первая, -/// сказал Стас.\\\ - Не будем привлекать лишнего внимания.///**Вы'+iif(alko >= 3,' покачнувшись','')+' встали и отправились в сторону туалета. Зайдя внутрь вы присели на унитаз в ожидании прихода Стаса. Наконец раздался осторожный стук в дверь, которую вы тут же открыли. Войдя внутрь Стас тут же впился в ваши губы страстным поцелуем.**\\- Подожди, -// прошептали между поцелуями.\\ - Дверь нужно закрыть...//**Стас, не выпуская выс из объятий протянул руку и вы услышали как счёлкнул замок на двери.'
			act 'Сосать':
				*clr & cla
				...
				gs 'zz_render', '', '','\\\- Я так кончу скоро! -/// простонал Стас.'
				act 'Сосать дальше':
					*clr & cla
					minut += 5
					gs 'zz_funcs', 'cum', 'face'
					gs 'stat'
					gs 'zz_render', '', 'images/city/south/stas/cafe_cumface.jpg', 'Вы с удвоенным старанием принялись работать своим ротиком. Застонав, Стас вынул член из вашего рта, и тут же начал кончать, обильно орошая ваше лицо вязкой и тёплой спермой.'+iif(hour < 17,'**\\\- Светик, ты тут давай, приводи себя в порядок, а я побежал в офис, -/// сказал Стас, застёгивая брюки.\\\ - Рабочий день ещё не закончился, как никак...///','')
					if hour < 17:
				...
				if stat_vgape < 2:
					act 'Отдаться':
						*clr & cla
						...
						pose = 1
						gs 'stat'
						gs 'zz_render', '', 'images/city/south/stas/cafe_vag.jpg', 'Вы встали раком, забравшись на опущенную крышку унитаза, и Стас начал пристраиваться к вашей  киске.'
						gs 'zz_dynamic_sex', 'sex_start'
						gs 'zz_dynamic_sex', 'vaginal', 'dick'
						gs 'zz_dynamic_sex', 'sex_cum'
						if hour < 17:
							gs 'zz_render', '', '', '\\\- Светик, ты тут давай, приводи себя в порядок, а я побежал в офис, -/// сказал Стас, застёгивая брюки.\\\ - Рабочий день ещё не закончился, как никак...///'
							act 'Далее': gt 'kafe','toilet'
						else
				...
				act 'Подставить попу':
					*clr & cla
					minut += 5
					gs 'stat'
					gs 'zz_render', '', 'images/city/south/stas/cafe_anal.jpg', 'Вы встали раком, забравшись на опущенную крышку унитаза, и Стас начал пристраиваться к вашей  задней дырочке.'
				...
				*clr & cla
				...
				act 'Сосать':
					*clr & cla
					...
					gs 'zz_dynamic_sex', 'bj'
					gs 'zz_render', '', '', '\\\- Не спеши -/// простонал Стас.\\\ - А то я так кончу скоро!///'
					act 'Расслабиться':
						*clr & cla
						horny += 20
						minut += 5
...
if $ARGS[0] = 'sex':
		...
		*clr & cla
		...
		act 'Стонать':
			*clr & cla
			...
			gs 'zz_dynamic_sex', 'sex_cum'
			gs 'zz_render', '', '', '\\\- Всё было замечательно Светик, -/// сказал Стас, поцеловав вас в губы.**Приняв душ, он оделся и поцеловав вас на прощание, отправился к выходу из квартиры.'
	...
	act 'Подставить попу':
		*clr & cla
		minut += 5
		gs 'stat'
		gs 'zz_render', '', 'images/city/south/stas/anal.jpg', 'Стас положил вас на бок и начал пристраиваться к вашей  задней дырочке.'
		gs 'zz_dynamic_sex', 'anal_start', 'dick'
		gs 'zz_dynamic_sex', 'anal', 'dick'
		act 'Стонать':
			*clr & cla
