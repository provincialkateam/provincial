...
if $args[0] = 'rent_event_1':
	*clr & cla
	...
	_stage = args[1]
	if _stage < 2:
		gs 'zz_render', '', 'city/center/agency_rent/R_'+ _stage, func('rent_flat_oleg_strings', $args[0], _stage)
	...
	elseif _stage >= 7 and _stage < 16:
		horny += 10
		gs 'zz_render', '', 'city/center/agency_rent/R_'+ _stage+ '.webm', func('rent_flat_oleg_strings', $args[0], _stage)
		act 'Далее': gt $curloc, 'rent_event_1', _stage+1
	elseif _stage = 16:
		horny = 0
		orgasm += 1
...
if $args[0] = 'rent_event_2':
	*clr & cla
	...
	if _stage < 1:
		gs 'zz_render', '', 'city/center/agency_rent/R_'+ $_m_img, func('rent_flat_oleg_strings', $args[0], _stage)
		if money >= 10000:
			act 'Заплатить':
				*clr & cla
				money -= 10000
	...
	elseif _stage >= 3 and _stage < 13:
		gs 'zz_render', '', 'city/center/agency_rent/R_'+ $_m_img + '.webm', func('rent_flat_oleg_strings', $args[0], _stage)
