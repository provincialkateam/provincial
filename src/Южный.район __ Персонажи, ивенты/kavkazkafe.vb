...
if $ARGS[0] = 'givibj5':
	...
	gs 'zz_funcs', 'cum', 'face'
	gs 'stat'
	gs 'zz_render','','common/sex/facial/<<rand(0,4)>>.jpg', func('kavkazkafe_strings', 'local_str41')
	act 'Уйти': gt 'south'
end
if $ARGS[0] = 'givibj6':
	minut += 3
	...
	gs 'zz_funcs', 'cum', 'lip'
	gs 'stat'
	gs 'zz_render','','common/sex/bj_cum/<<rand(0,4)>>.gif', func('kavkazkafe_strings', 'local_str42')
	act 'Уйти': gt 'south'
end
if $ARGS[0] = 'givisex':
	minut += 3
	...
	if $npc['34,sex'] > 5:
		if RAND(0,100) >= 75 and anal > 0:
			cla
			gs 'zz_render','','', 'Свэтик, я тебя в попку хочу.'
