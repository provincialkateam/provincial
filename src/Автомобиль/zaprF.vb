...
minut += 5
gs 'stat'
gs 'zz_render','АЗС','pic/zapr.jpg','В связи с особенностями устройства бензоколонок, все автомобили заправляются до полного бака.**Стоимость 1 литра бензина - 30 рублей.'
gs 'car', 'check'
