gs 'stat'
gs 'zz_render','','images/pic/kpz.jpg','Большая камера с деревянными лавками.'
if kameraKPZ < 3:
	act 'Сидеть':
		cla
		minut += 60
