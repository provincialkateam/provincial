if $ARGS[0] = 'start':
	*clr & cla
	...
	gs 'zz_render', 'Фотостудия', 'images/pic/foto.jpg', func('foto_strings', 'local_str1')
...
if $ARGS[0] = 'model':
	*clr & cla
	if vnesh >= 40:
		...
		modelmon = month
		gs 'stat'
		gs 'zz_render', 'Фотограф', 'images/pic/fotograph.jpg', func('foto_strings', 'local_str13')
		forand = RAND(1,7)
		if forand = 1:
				...
				act 'Пройти в комнату':
					...
					act 'Открыть рот':
						*clr & cla
						...
						pose = 1
						dick = 18
						gs 'zz_render', '', 'images/pics/studia.jpg', func('foto_strings', 'local_str33')
							...
							*clr & cla
							...
							act 'В душ':
								...
								act 'Нет!':
									...
									gs 'zz_render', '', 'images/pics/studia2.jpg', func('foto_strings', 'local_str37')
									act 'Подмыться':
										*clr & cla
										sex += 1
										anal += 1
										...
										pose = 1
										dick = 18
										gs 'zz_render', '', 'images/pics/studia3.jpg', func('foto_strings', 'local_str38')
										gs 'zz_dynamic_sex', 'sex_start'
										gs 'zz_dynamic_sex', 'vaginal', 'dick'
