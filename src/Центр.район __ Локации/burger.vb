							...
							*clr & cla
							...
							act 'Сделать минет':
								*clr & cla
								...
								gs 'zz_funcs', 'cum', 'lip'
								gs 'stat'
								gs 'zz_render','','common/sex/bj/<<rand(0,4)>>.gif', func('burger_strings', 'local_str15')
								act 'Выйти из бутика':
									*clr & cla
									minut += 15
									gs 'stat'
								...
								*clr & cla
								...
								act 'Испуганно смотреть':
									*clr & cla
									...
									gs 'zz_clothing2','add_rand_dress',4
									gs 'stat'
									gs 'zz_render','','common/sex/bj/<<rand(0,4)>>.gif', func('burger_strings', 'local_str18')
									act 'Облизать':
										*clr & cla
										minut += 2
										gs 'stat'
										gs 'zz_render','','common/sex/bj/<<rand(0,4)>>.gif', func('burger_strings', 'local_str19')
										act 'Лизать член':
											*clr & cla
											minut += 2
											gs 'stat'
											gs 'zz_render','','common/sex/bj/<<rand(0,4)>>.gif', func('burger_strings', 'local_str20')
											act 'Сосать член':
												*clr & cla
												minut += 2
												gs 'zz_funcs', 'cum', 'lip'
												...
												gs 'stat'
												gs 'zz_render','','common/sex/bj_cum/<<rand(0,4)>>.gif', func('burger_strings', 'local_str21')
												act 'Сидеть на полу':
													*clr & cla
													minut += 2
													gs 'stat'
													gs 'zz_render','','common/sex/bj_cum/<<rand(0,4)>>.gif', func('burger_strings', 'local_str22')
													act 'Выйти из примерочной':
														*clr & cla
														minut += 2
														gs 'stat'
														gs 'zz_render','','common/sex/bj_cum/<<rand(0,4)>>.gif', func('burger_strings', 'local_str23')
														act 'Выйти из бутика':
															*clr & cla
															minut += 15
															gs 'stat'
					...
					*clr & cla
					...
					act 'Покорно кивнуть головой':
						*clr & cla
						...
						guy += 1
						gs 'stat'
						gs 'zz_render','','common/sex/bj/<<rand(0,4)>>.gif', func('burger_strings', 'local_str47')
						act 'Уйти':gt'burger','start'
					end
					act 'Послать его':
						*clr & cla
			...
			elseif $npc['0,qwBistro'] >= 65 and soplakTimes ! 3:
				...
				act 'Работать ртом':
					*clr & cla
					...
					dom -= 1
					gs 'stat'
					gs 'zz_render','','common/sex/bj/0.gif', func('burger_strings', 'local_str52')
					act '...':
						*clr & cla
						gs 'zz_funcs', 'cum', 'lip'
						money += 300
						...
						gs 'stat'
						gs 'zz_render', '', 'common/sex/bj_cum/<<rand(0,4)>>.gif', func('burger_strings', 'local_str53')
						act 'Уйти':gt'burger','start'
					end
				end
				exit
