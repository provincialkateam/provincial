...
if $ARGS[0] = 'sex':
	...
	pose = 0
	gs 'stat'
	gs 'zz_render','','images/picV/vag.jpg'
...
if $ARGS[0] = 'sex2':
	...
	pose = 1
	gs 'stat'
	gs 'zz_render','','images/pics/vagdog'+RAND(1,5)+'.jpg'
	gs 'zz_dynamic_sex', 'sex_start'
	gs 'zz_dynamic_sex', 'vaginal', 'dick'
	if harakBoy > 0:
		if RAND(0,10) >= 8:
...
if $ARGS[0] = 'facial':
	...
	minut += 3
	gs 'stat'
	gs 'zz_render','','common/sex/facial/<<rand(0,4)>>.jpg', func('BDsex_strings', 'local_str40')
...
if $ARGS[0] = 'end':
	...
	if GoToGuy = 0:
		...
		act 'Уйти':
			if GoToGuy = 1: GoToGuy = 0 & gt 'north'
			if GoToGuy = 2: GoToGuy = 0 & gt 'south'
		end
	end
end