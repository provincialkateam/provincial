...
if BistroBoss = 10:
	...
	elseif PersSecWork = 1:
		if week < 6 and hour < 10 and func('zz_clothing2','get_group') = 6:
		...
		elseif week < 6 and hour < 10 and func('zz_clothing2','get_group') ! 6:
		...
		elseif $npc['0,qwBistro'] >= 65:
			...
			act 'Встать на колени':
				*clr & cla
				...
				BistroBossDay = day
				gs 'stat'
				gs 'zz_render', '', 'common/sex/bj/<<rand(0,4)>>.gif', func('burgerBoss_strings', 'local_str13')
				act 'Уйти':gt'burger','start'
			end
		end
	end
...
elseif BistroBoss = 2 and BistroBossDay ! day:
	...
	act 'Встать на колени':
		*clr & cla
		...
		BistroBossDay = day
		gs 'stat'
		gs 'zz_render', '', 'common/sex/bj/<<rand(0,4)>>.gif', func('burgerBoss_strings', 'local_str16')
		act 'Уйти':gt'burger','start'
	end
end