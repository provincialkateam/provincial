	...
	*clr & cla
	...
	act 'Идти за Настей':
		*clr & cla
		...
		act 'Разъехаться по домам':gt'south'
	end
end
if $ARGS[0] = 'pos9':
	*clr & cla
		...
		*clr & cla
				...
				*clr & cla
				...
				act 'Надеть трусики наклонившись и выпятив попу!':
					*clr & cla
					...
					act 'Выбежать и уехать с Настей на такси':gt'south'
				end
			end
		end
		act 'Подсмотреть что будет':
			*clr & cla
			...
			act 'Сесть в такси и разъехаться по домам':gt'south'
		end
	end
end
if $ARGS[0] = 'pos10':
