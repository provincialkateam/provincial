if $args[0] = '' or $args[0] = 'main':
	$_str[0] = 'Лестница упирается в аккурат в двери кинотеатра "ГЭС". Кинотеатр навороченный, дорогой. Крутят в основном модные блокбастеры в 3D.'
	$_str[1] = 'Небольшой кинотеатр, в котором есть всего один небольшой зал.'
	...
	!$_str[8] = ''
	! ---
	! 0 - для городского дорогого кинотеатра
	! 1 - обычный небольшой кинотеатр
	_cinema = args[1]
	gs 'zz_funcs', 'colorize_day'
	gs 'zz_render','','common/cinema/cinema.jpg',$_str[_cinema]
	act 'Сходить в кино ('+iif(_cinema=0,200,100)+'р.)':
		if money < iif(_cinema=0,200,100):
			gs 'zz_render','','',$_str[4]
			gs $curloc,'finish'
			exit
		end
		*clr & cla
		money -= iif(_cinema=0,200,100)
		minut += 120
		manna += RAND(20,30)
		i = rand(1,100)
