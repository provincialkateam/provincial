...
if $args[0] = 'street_cum':
	if cumfrot > 0 or cumface > 0:
		if hour >= 7 and hour <= 21:
			manna -= 5
			if face_write > 0:
				'Прохожие недоуменно оборачиваются пристально разглядывая вас - одни с удивлением, а другие с презрением. Кто то улыбается и показывает пальцем. Некоторые фотографируют на телефон вас, совершенно этого не скрывая и хихикая над вами. На вас явно заметна сперма и впридачу разрисовано лицо.'
			else
	...
	elseif face_write > 0:
		manna -= 5
		'Окружающие смотрят на вас с удивлением, ухмылкой или легким презрением. Кто то просто показывают пальцем и смеется. Кто то фотографирует на телефон. Волосы явно не могут скрыть "художества" на вашем лице.'
	end
end