...
gs 'zz_render','Ваша комната','pavlovo/family/apartment/bedr.jpg','Маленькая комната, куда с трудом втиснулись <a href="exec:GT ''loker'',''start''">шкаф</a>, ваши <a href="exec: gs ''bed'',''start''">кровать</a> и кровать сестры, письменный стол и <a href="exec:gt ''zz_books'',''main''">книжная полка</a>.'
...
if komp = 1: act 'Ноутбук': gt 'Komp','start'