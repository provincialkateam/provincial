...
if hour >= 7 and narkossister = 0:
	...
	if current_clothing <= 2 and pregTalkSister = 0 and pregnancy > 90:
		gs 'zz_render', '', '', func('sister_strings', 'local_str6')
		pregTalkSister = 1
	end
	if current_clothing > 2 and pregTalkSister = 0 and pregnancy > 150:
	...
	if $npc['38,relation'] > 65 and mesec > 0 and pregnancy = 0 and tampon = 0 and narkossister = 0:
